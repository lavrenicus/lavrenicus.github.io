...
`,mM=new L(4,10,4).normalize();function Cu(s){const e=s,t=e.map??null,n=e.color?e.color.clone():new Ne(16777215),i=e.opacity??1,r=e.transparent??i<1,a=e.side??an,o=e.alphaTest??0;return new yt({vertexShader:fM,fragmentShader:pM,uniforms:{map:{value:t},color:{value:n},lightDir:{value:mM.clone()},levels:{value:3},rimStrength:{value:.4},rimPower:{value:2},opacity:{value:i},crestStrength:{value:.01},crestWidth:{value:.01}},transparent:r,side:a,alphaTest:o,extensions:{derivatives:!0}})}function gM(s){const e=s.material;Array.isArray(e)?s.material=e.map(t=>Cu(t)):s.material=Cu(e)}function Iu(s){s.traverse(e=>{const t=e;t.isMesh&&gM(t)})}const _M=.5*1.5;function vM(s){return!s.startsWith("/")&&!s.startsWith("http")?`/demos/pixiandestroy/models/${s}.glb`:s}function xM(){const s=new Xt;return s.add(new vt(new bl(.15,.3,4,8),nS())),s}function Pu(s){s.rotation.y=Math.PI/4;const t=new Rn().setFromObject(s).getSize(new L),n=Math.max(t.x,t.y,t.z,.001)/1.5,i=_M/n;s.scale.setScalar(i)}function SM(){const e=ia().map(a=>[a.unitType,a.modelGlb]),t=Object.fromEntries(e),n=t.commander,i=t.archer,r=t.swordsman;if(!n||!i||!r)throw new Error("[loadUnitModels] отсутствует modelGlb в конфиге бойцов");return{commander:n,archer:i,swordsman:r}}async function yM(s){const e=SM(),t=async a=>{try{const o=await dM(vM(e[a]),l=>s==null?void 0:s({name:a,progress:l}));return Pu(o),Iu(o),o}catch(o){console.warn(`[loadUnitModels] не удалось загрузить модель для ${a}:`,o);const l=xM();return Pu(l),Iu(l),l}},[n,i,r]=await Promise.all([t("commander"),t("archer"),t("swordsman")]);return{commander:n,archer:i,swordsman:r}}const Yi=["commander","archer","swordsman"];function MM(s){return s<0?0:s>1?1:s}function EM(s){return Math.round(MM(s)*100)}function TM(s){if(Yi.every(n=>typeof s[n].total=="number"&&(s[n].total??0)>0)){const n=Yi.reduce((r,a)=>r+(s[a].total??0),0),i=Yi.reduce((r,a)=>r+Math.min(s[a].loaded??0,s[a].total??0),0);return n>0?i/n:0}return Yi.filter(n=>s[n].done).length/Yi.length}function bM(s){return s==="commander"?"Командир":s==="archer"?"Лучник":"Мечник"}async function AM(s){const n={commander:{done:!1},archer:{done:!1},swordsman:{done:!1}},i=l=>{const c=TM(n),u=.05*1+.95*c;s==null||s({percent:EM(u),detail:l})};s==null||s({percent:0,detail:"Загрузка конфига…"});const r=await Iy();i("Загрузка текстур…");const a=await new Promise((l,c)=>{new gh().load(Xs("/textures/arrow.png"),l,void 0,c)});a.wrapS=nn,a.wrapT=nn,a.flipY=!1,a.minFilter=rt,a.magFilter=rt,a.needsUpdate=!0,i("Загрузка моделей…");const o=await yM(l=>{const c=l.name;n[c].loaded=l.progress.loaded,n[c].total=l.progress.total,i(`Модель: ${bM(c)}…`)}).then(l=>{for(const c of Yi)n[c].done=!0;return i("Готово"),l});return s==null||s({percent:100,detail:"Готово"}),{appConfig:r,unitModels:o,arrowTexture:a}}const pd="gridlock_total_games_completed";function Ks(s,e){typeof window.gtag=="function"&&window.gtag("event",s,e)}function wM(s,e){typeof window.gtag=="function"&&window.gtag("set","user_properties",{[s]:e})}function RM(){if(typeof window>"u"||!window.localStorage)return 0;const s=window.localStorage.getItem(pd),e=s?parseInt(s,10):0;return Number.isNaN(e)?0:e}function CM(){const s=RM()+1;return typeof window<"u"&&window.localStorage&&window.localStorage.setItem(pd,String(s)),wM("total_games_completed",s),s}function IM(s){Ks("mode_select",{mode:s})}function PM(s,e){Ks("game_start",{mode:s,game_number_in_session:e})}function Du(s){Ks("player_move",{mode:s})}function Lu(s,e,t){Ks("game_over",{mode:s,result:e,game_number_in_session:t}),CM()}function DM(){Ks("play_again_click")}const md="fire",gd="Огонь",_d="/demos/pixiandestroy/textures/commander_face.jpg",vd=200,LM={id:md,title:gd,avatarImg:_d,price:vd},NM=Object.freeze(Object.defineProperty({__proto__:null,avatarImg:_d,default:LM,id:md,price:vd,title:gd},Symbol.toStringTag,{value:"Module"})),xd="ice",Sd="Лед",yd="/demos/pixiandestroy/textures/archer_face.jpg",Md=150,UM={id:xd,title:Sd,avatarImg:yd,price:Md},FM=Object.freeze(Object.defineProperty({__proto__:null,avatarImg:yd,default:UM,id:xd,price:Md,title:Sd},Symbol.toStringTag,{value:"Module"})),OM=Object.assign({"./configs/fire.json":NM,"./configs/ice.json":FM});function BM(s){return{...s,avatarImg:Xs(s.avatarImg)}}function Ed(){return Object.values(OM).map(s=>BM(s.default))}function kM(s){const t=Ed().find(n=>n.id===s);if(!t)throw new Error(`[skins] неизвестный skinId: ${s}`);return t}class zM{constructor(e){Le(this,"data");Le(this,"owned");Le(this,"disabled");this.data=e.data,this.owned=e.owned,this.disabled=e.disabled}render(){const e=this.data.kind==="skin"?"СКИН":"ЮНИТ",t=this.data.kind==="skin"?"badge-skin":"badge-unit";return`
    ...
    `}renderTab(e){return e==="home"?this.renderHomeTab():e==="team"?this.renderTeamTab():this.renderShopTab()}renderHomeTab(){const e=Cs(this.state.selectedLevel),t=Cs(this.state.currentLevel),n=Fu[e],i=[1,2,3,4,5].map(o=>{const l=o<=t,c=o===e;let u="map-level-node";return l&&(u+=" unlocked"),c&&(u+=" selected"),o===t&&(u+=" current"),`
