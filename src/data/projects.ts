...
export const projects: ProjectItem[] = [
  ...
  },
  {
    ...
    stack: ["Render Farm", "Deadline", "3D Software", "Pipeline Operations"],
    scope: "team",
    status: "completed",
  },
  {
    ...
    title: "SpriteMaster",
    year: 2024,
    meta: "offline-first Spine sprite editor · React/PixiJS · ONNX",
    description: "Raster sprite preparation for 2D animation in Spine: mask Extract/Add/Remove/Refine, local ONNX segmentation, background inpainting (LaMa), procedural rig, PSD/Spine JSON 4.2/atlas export.",
    stack: ["TypeScript", "React", "PixiJS", "Vite", "Python", "ONNX"],
    scope: "personal",
    status: "in development",
  },
  {
    id: "desktop-village",
    title: "desktopVillage",
    year: 2024,
    meta: "live wallpaper · Three.js · ECS",
    description: "Autonomous isometric life simulation — villagers are born, work, build, and die. Modes: desktop wallpaper, interactive sandbox.",
    stack: ["TypeScript", "Three.js", "Vite", "ECS"],
    scope: "personal",
    status: "prototype",
  },
  {
    ...
    title: "SmartPool",
    year: 2025,
    meta: "computer vision · AR · C++ · bgfx",
    description: "AR billiard table tracker: real-time camera calibration via homography, ball detection, pocket recognition — for Android TV.",
    stack: ["C++", "OpenCV", "bgfx", "Android NDK", "ESL shaders"],
    scope: "team",
    status: "in development",
  },
  {
    ...
    description: "Graph neural network that automates character rigging from mesh data: Sparse3DEncoder + GraphAttentionDecoder with anatomical prior.",
    stack: ["Python", "PyTorch", "3D CV"],
    scope: "personal",
    status: "in development",
  },
];
...
export const games: GameItem[] = [
  {
    ...
    meta: "tactical grid game · Three.js · playable prototype",
...
export const socialLinks: SocialLink[] = [
  { label: "github", href: "https://github.com/lavrenicus", external: true },
  { label: "sketchfab", href: "https://sketchfab.com/modelicus", external: true },
  { label: "linkedin", href: "https://www.linkedin.com/in/ilialavrov/", external: true },
  { label: "email", href: "mailto:lavrenicus@gmail.com", external: false },
];
