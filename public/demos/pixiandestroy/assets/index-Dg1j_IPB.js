...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:bn,depthTest:!1,depthWrite:!1})}function Vc(){return new yt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ta(),fragmentShader:`
		...
		`,blending:bn,depthTest:!1,depthWrite:!1})}function Gc(){return new yt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ta(),fragmentShader:`
	...
	`}class Sh extends Bt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},i=[n,n,n,n,n,n];this.texture=new lh(i),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},i=new ds(5,5,5),r=new yt({name:"CubemapFromEquirect",uniforms:os(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:qt,blending:bn});r.uniforms.tEquirect.value=t;const a=new vt(i,r),o=t.minFilter;return t.minFilter===zn&&(t.minFilter=St),new Wp(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,n=!0,i=!0){const r=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,n,i);e.setRenderTarget(r)}}function e0(s){let e=new WeakMap,t=new WeakMap,n=null;function i(h,f=!1){return h==null?null:f?a(h):r(h)}function r(h){if(h&&h.isTexture){const f=h.mapping;if(f===oa||f===la)if(e.has(h)){const g=e.get(h).texture;return o(g,h.mapping)}else{const g=h.image;if(g&&g.height>0){const S=new Sh(g.height);return S.fromEquirectangularTexture(s,h),e.set(h,S),h.addEventListener("dispose",c),o(S.texture,h.mapping)}else return null}}return h}function a(h){if(h&&h.isTexture){const f=h.mapping,g=f===oa||f===la,S=f===yi||f===ns;if(g||S){let m=t.get(h);const p=m!==void 0?m.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==p)return n===null&&(n=new kc(s)),m=g?n.fromEquirectangular(h,m):n.fromCubemap(h,m),m.texture.pmremVersion=h.pmremVersion,t.set(h,m),m.texture;if(m!==void 0)return m.texture;{const v=h.image;return g&&v&&v.height>0||S&&v&&l(v)?(n===null&&(n=new kc(s)),m=g?n.fromEquirectangular(h):n.fromCubemap(h),m.texture.pmremVersion=h.pmremVersion,t.set(h,m),h.addEventListener("dispose",u),m.texture):null}}}return h}function o(h,f){return f===oa?h.mapping=yi:f===la&&(h.mapping=ns),h}function l(h){let f=0;const g=6;for(let S=0;S<g;S++)h[S]!==void 0&&f++;return f===g}function c(h){const f=h.target;f.removeEventListener("dispose",c);const g=e.get(f);g!==void 0&&(e.delete(f),g.dispose())}function u(h){const f=h.target;f.removeEventListener("dispose",u);const g=t.get(f);g!==void 0&&(t.delete(f),g.dispose())}function d(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:i,dispose:d}}function t0(s){const e={};function t(n){if(e[n]!==void 0)return e[n];const i=s.getExtension(n);return e[n]=i,i}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const i=t(n);return i===null&&qr("WebGLRenderer: "+n+" extension not supported."),i}}}function n0(s,e,t,n){const i={},r=new WeakMap;function a(d){const h=d.target;h.index!==null&&e.remove(h.index);for(const g in h.attributes)e.remove(h.attributes[g]);h.removeEventListener("dispose",a),delete i[h.id];const f=r.get(h);f&&(e.remove(f),r.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function o(d,h){return i[h.id]===!0||(h.addEventListener("dispose",a),i[h.id]=!0,t.memory.geometries++),h}function l(d){const h=d.attributes;for(const f in h)e.update(h[f],s.ARRAY_BUFFER)}function c(d){const h=[],f=d.index,g=d.attributes.position;let S=0;if(g===void 0)return;if(f!==null){const v=f.array;S=f.version;for(let M=0,E=v.length;M<E;M+=3){const A=v[M+0],w=v[M+1],C=v[M+2];h.push(A,w,w,C,C,A)}}else{const v=g.array;S=g.version;for(let M=0,E=v.length/3-1;M<E;M+=3){const A=M+0,w=M+1,C=M+2;h.push(A,w,w,C,C,A)}}const m=new(g.count>=65535?sh:ih)(h,1);m.version=S;const p=r.get(d);p&&e.remove(p),r.set(d,m)}function u(d){const h=r.get(d);if(h){const f=d.index;f!==null&&h.version<f.version&&c(d)}else c(d);return r.get(d)}return{get:o,update:l,getWireframeAttribute:u}}function i0(s,e,t){let n;function i(h){n=h}let r,a;function o(h){r=h.type,a=h.bytesPerElement}function l(h,f){s.drawElements(n,f,r,h*a),t.update(f,n,1)}function c(h,f,g){g!==0&&(s.drawElementsInstanced(n,f,r,h*a,g),t.update(f,n,g))}function u(h,f,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,f,0,r,h,0,g);let m=0;for(let p=0;p<g;p++)m+=f[p];t.update(m,n,1)}function d(h,f,g,S){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<h.length;p++)c(h[p]/a,f[p],S[p]);else{m.multiDrawElementsInstancedWEBGL(n,f,0,r,h,0,S,0,g);let p=0;for(let v=0;v<g;v++)p+=f[v]*S[v];t.update(p,n,1)}}this.setMode=i,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=d}function s0(s){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case s.TRIANGLES:t.triangles+=o*(r/3);break;case s.LINES:t.lines+=o*(r/2);break;case s.LINE_STRIP:t.lines+=o*(r-1);break;case s.LINE_LOOP:t.lines+=o*r;break;case s.POINTS:t.points+=o*r;break;default:Pe("WebGLInfo: Unknown draw mode:",a);break}}function i(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:i,update:n}}function r0(s,e,t){const n=new WeakMap,i=new ft;function r(a,o,l){const c=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,d=u!==void 0?u.length:0;let h=n.get(o);if(h===void 0||h.count!==d){let H=function(){x.dispose(),n.delete(o),o.removeEventListener("dispose",H)};var f=H;h!==void 0&&h.texture.dispose();const g=o.morphAttributes.position!==void 0,S=o.morphAttributes.normal!==void 0,m=o.morphAttributes.color!==void 0,p=o.morphAttributes.position||[],v=o.morphAttributes.normal||[],M=o.morphAttributes.color||[];let E=0;g===!0&&(E=1),S===!0&&(E=2),m===!0&&(E=3);let A=o.attributes.position.count*E,w=1;A>e.maxTextureSize&&(w=Math.ceil(A/e.maxTextureSize),A=e.maxTextureSize);const C=new Float32Array(A*w*4*d),x=new th(C,A,w,d);x.type=sn,x.needsUpdate=!0;const T=E*4;for(let R=0;R<d;R++){const F=p[R],k=v[R],q=M[R],O=A*w*4*R;for(let G=0;G<F.count;G++){const U=G*T;g===!0&&(i.fromBufferAttribute(F,G),C[O+U+0]=i.x,C[O+U+1]=i.y,C[O+U+2]=i.z,C[O+U+3]=0),S===!0&&(i.fromBufferAttribute(k,G),C[O+U+4]=i.x,C[O+U+5]=i.y,C[O+U+6]=i.z,C[O+U+7]=0),m===!0&&(i.fromBufferAttribute(q,G),C[O+U+8]=i.x,C[O+U+9]=i.y,C[O+U+10]=i.z,C[O+U+11]=q.itemSize===4?i.w:1)}}h={count:d,texture:x,size:new Be(A,w)},n.set(o,h),o.addEventListener("dispose",H)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(s,"morphTexture",a.morphTexture,t);else{let g=0;for(let m=0;m<c.length;m++)g+=c[m];const S=o.morphTargetsRelative?1:1-g;l.getUniforms().setValue(s,"morphTargetBaseInfluence",S),l.getUniforms().setValue(s,"morphTargetInfluences",c)}l.getUniforms().setValue(s,"morphTargetsTexture",h.texture,t),l.getUniforms().setValue(s,"morphTargetsTextureSize",h.size)}return{update:r}}function a0(s,e,t,n,i){let r=new WeakMap;function a(c){const u=i.render.frame,d=c.geometry,h=e.get(c,d);if(r.get(h)!==u&&(e.update(h),r.set(h,u)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),r.get(c)!==u&&(t.update(c.instanceMatrix,s.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,s.ARRAY_BUFFER),r.set(c,u))),c.isSkinnedMesh){const f=c.skeleton;r.get(f)!==u&&(f.update(),r.set(f,u))}return h}function o(){r=new WeakMap}function l(c){const u=c.target;u.removeEventListener("dispose",l),n.releaseStatesOfObject(u),t.remove(u.instanceMatrix),u.instanceColor!==null&&t.remove(u.instanceColor)}return{update:a,dispose:o}}const o0={[el]:"LINEAR_TONE_MAPPING",[tl]:"REINHARD_TONE_MAPPING",[nl]:"CINEON_TONE_MAPPING",[Zr]:"ACES_FILMIC_TONE_MAPPING",[sl]:"AGX_TONE_MAPPING",[rl]:"NEUTRAL_TONE_MAPPING",[il]:"CUSTOM_TONE_MAPPING"};function l0(s,e,t,n,i){const r=new Bt(e,t,{type:s,depthBuffer:n,stencilBuffer:i}),a=new Bt(e,t,{type:Qt,depthBuffer:!1,stencilBuffer:!1}),o=new Vt;o.setAttribute("position",new bt([-1,3,0,-1,-1,0,3,-1,0],3)),o.setAttribute("uv",new bt([0,2,0,0,2,0],2));const l=new hh({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),c=new vt(o,l),u=new _s(-1,1,1,-1,0,1);let d=null,h=null,f=!1,g,S=null,m=[],p=!1;this.setSize=function(v,M){r.setSize(v,M),a.setSize(v,M);for(let E=0;E<m.length;E++){const A=m[E];A.setSize&&A.setSize(v,M)}},this.setEffects=function(v){m=v,p=m.length>0&&m[0].isRenderPass===!0;const M=r.width,E=r.height;for(let A=0;A<m.length;A++){const w=m[A];w.setSize&&w.setSize(M,E)}},this.begin=function(v,M){if(f||v.toneMapping===An&&m.length===0)return!1;if(S=M,M!==null){const E=M.width,A=M.height;(r.width!==E||r.height!==A)&&this.setSize(E,A)}return p===!1&&v.setRenderTarget(r),g=v.toneMapping,v.toneMapping=An,!0},this.hasRenderPass=function(){return p},this.end=function(v,M){v.toneMapping=g,f=!0;let E=r,A=a;for(let w=0;w<m.length;w++){const C=m[w];if(C.enabled!==!1&&(C.render(v,A,E,M),C.needsSwap!==!1)){const x=E;E=A,A=x}}if(d!==v.outputColorSpace||h!==v.toneMapping){d=v.outputColorSpace,h=v.toneMapping,l.defines={},$e.getTransfer(d)===tt&&(l.defines.SRGB_TRANSFER="");const w=o0[h];w&&(l.defines[w]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=E.texture,v.setRenderTarget(S),v.render(c,u),S=null,f=!1},this.isCompositing=function(){return f},this.dispose=function(){r.dispose(),a.dispose(),o.dispose(),l.dispose()}}const yh=new It,qo=new as(1,1),Mh=new th,Eh=new Yf,Th=new lh,Hc=[],Wc=[],Xc=new Float32Array(16),qc=new Float32Array(9),Yc=new Float32Array(4);function vs(s,e,t){const n=s[0];if(n<=0||n>0)return s;const i=e*t;let r=Hc[i];if(r===void 0&&(r=new Float32Array(i),Hc[i]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,s[a].toArray(r,o)}return r}function At(s,e){if(s.length!==e.length)return!1;for(let t=0,n=s.length;t<n;t++)if(s[t]!==e[t])return!1;return!0}function wt(s,e){for(let t=0,n=e.length;t<n;t++)s[t]=e[t]}function na(s,e){let t=Wc[e];t===void 0&&(t=new Int32Array(e),Wc[e]=t);for(let n=0;n!==e;++n)t[n]=s.allocateTextureUnit();return t}function c0(s,e){const t=this.cache;t[0]!==e&&(s.uniform1f(this.addr,e),t[0]=e)}function u0(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(At(t,e))return;s.uniform2fv(this.addr,e),wt(t,e)}}function h0(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(s.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(At(t,e))return;s.uniform3fv(this.addr,e),wt(t,e)}}function d0(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(At(t,e))return;s.uniform4fv(this.addr,e),wt(t,e)}}function f0(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(At(t,e))return;s.uniformMatrix2fv(this.addr,!1,e),wt(t,e)}else{if(At(t,n))return;Yc.set(n),s.uniformMatrix2fv(this.addr,!1,Yc),wt(t,n)}}function p0(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(At(t,e))return;s.uniformMatrix3fv(this.addr,!1,e),wt(t,e)}else{if(At(t,n))return;qc.set(n),s.uniformMatrix3fv(this.addr,!1,qc),wt(t,n)}}function m0(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(At(t,e))return;s.uniformMatrix4fv(this.addr,!1,e),wt(t,e)}else{if(At(t,n))return;Xc.set(n),s.uniformMatrix4fv(this.addr,!1,Xc),wt(t,n)}}function g0(s,e){const t=this.cache;t[0]!==e&&(s.uniform1i(this.addr,e),t[0]=e)}function _0(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(At(t,e))return;s.uniform2iv(this.addr,e),wt(t,e)}}function v0(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(At(t,e))return;s.uniform3iv(this.addr,e),wt(t,e)}}function x0(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(At(t,e))return;s.uniform4iv(this.addr,e),wt(t,e)}}function S0(s,e){const t=this.cache;t[0]!==e&&(s.uniform1ui(this.addr,e),t[0]=e)}function y0(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(At(t,e))return;s.uniform2uiv(this.addr,e),wt(t,e)}}function M0(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(At(t,e))return;s.uniform3uiv(this.addr,e),wt(t,e)}}function E0(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(At(t,e))return;s.uniform4uiv(this.addr,e),wt(t,e)}}function T0(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i);let r;this.type===s.SAMPLER_2D_SHADOW?(qo.compareFunction=t.isReversedDepthBuffer()?gl:ml,r=qo):r=yh,t.setTexture2D(e||r,i)}function b0(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture3D(e||Eh,i)}function A0(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTextureCube(e||Th,i)}function w0(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture2DArray(e||Mh,i)}function R0(s){switch(s){case 5126:return c0;case 35664:return u0;case 35665:return h0;case 35666:return d0;case 35674:return f0;case 35675:return p0;case 35676:return m0;case 5124:case 35670:return g0;case 35667:case 35671:return _0;case 35668:case 35672:return v0;case 35669:case 35673:return x0;case 5125:return S0;case 36294:return y0;case 36295:return M0;case 36296:return E0;case 35678:case 36198:case 36298:case 36306:case 35682:return T0;case 35679:case 36299:case 36307:return b0;case 35680:case 36300:case 36308:case 36293:return A0;case 36289:case 36303:case 36311:case 36292:return w0}}function C0(s,e){s.uniform1fv(this.addr,e)}function I0(s,e){const t=vs(e,this.size,2);s.uniform2fv(this.addr,t)}function P0(s,e){const t=vs(e,this.size,3);s.uniform3fv(this.addr,t)}function D0(s,e){const t=vs(e,this.size,4);s.uniform4fv(this.addr,t)}function L0(s,e){const t=vs(e,this.size,4);s.uniformMatrix2fv(this.addr,!1,t)}function N0(s,e){const t=vs(e,this.size,9);s.uniformMatrix3fv(this.addr,!1,t)}function U0(s,e){const t=vs(e,this.size,16);s.uniformMatrix4fv(this.addr,!1,t)}function F0(s,e){s.uniform1iv(this.addr,e)}function O0(s,e){s.uniform2iv(this.addr,e)}function B0(s,e){s.uniform3iv(this.addr,e)}function k0(s,e){s.uniform4iv(this.addr,e)}function z0(s,e){s.uniform1uiv(this.addr,e)}function V0(s,e){s.uniform2uiv(this.addr,e)}function G0(s,e){s.uniform3uiv(this.addr,e)}function H0(s,e){s.uniform4uiv(this.addr,e)}function W0(s,e,t){const n=this.cache,i=e.length,r=na(t,i);At(n,r)||(s.uniform1iv(this.addr,r),wt(n,r));let a;this.type===s.SAMPLER_2D_SHADOW?a=qo:a=yh;for(let o=0;o!==i;++o)t.setTexture2D(e[o]||a,r[o])}function X0(s,e,t){const n=this.cache,i=e.length,r=na(t,i);At(n,r)||(s.uniform1iv(this.addr,r),wt(n,r));for(let a=0;a!==i;++a)t.setTexture3D(e[a]||Eh,r[a])}function q0(s,e,t){const n=this.cache,i=e.length,r=na(t,i);At(n,r)||(s.uniform1iv(this.addr,r),wt(n,r));for(let a=0;a!==i;++a)t.setTextureCube(e[a]||Th,r[a])}function Y0(s,e,t){const n=this.cache,i=e.length,r=na(t,i);At(n,r)||(s.uniform1iv(this.addr,r),wt(n,r));for(let a=0;a!==i;++a)t.setTexture2DArray(e[a]||Mh,r[a])}function $0(s){switch(s){case 5126:return C0;case 35664:return I0;case 35665:return P0;case 35666:return D0;case 35674:return L0;case 35675:return N0;case 35676:return U0;case 5124:case 35670:return F0;case 35667:case 35671:return O0;case 35668:case 35672:return B0;case 35669:case 35673:return k0;case 5125:return z0;case 36294:return V0;case 36295:return G0;case 36296:return H0;case 35678:case 36198:case 36298:case 36306:case 35682:return W0;case 35679:case 36299:case 36307:return X0;case 35680:case 36300:case 36308:case 36293:return q0;case 36289:case 36303:case 36311:case 36292:return Y0}}class K0{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=R0(t.type)}}class j0{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=$0(t.type)}}class Z0{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const i=this.seq;for(let r=0,a=i.length;r!==a;++r){const o=i[r];o.setValue(e,t[o.id],n)}}}const Va=/(\w+)(\])?(\[|\.)?/g;function $c(s,e){s.seq.push(e),s.map[e.id]=e}function J0(s,e,t){const n=s.name,i=n.length;for(Va.lastIndex=0;;){const r=Va.exec(n),a=Va.lastIndex;let o=r[1];const l=r[2]==="]",c=r[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===i){$c(t,c===void 0?new K0(o,s,e):new j0(o,s,e));break}else{let d=t.map[o];d===void 0&&(d=new Z0(o),$c(t,d)),t=d}}}class Br{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<n;++a){const o=e.getActiveUniform(t,a),l=e.getUniformLocation(t,o.name);J0(o,l,this)}const i=[],r=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?i.push(a):r.push(a);i.length>0&&(this.seq=i.concat(r))}setValue(e,t,n,i){const r=this.map[t];r!==void 0&&r.setValue(e,n,i)}setOptional(e,t,n){const i=t[n];i!==void 0&&this.setValue(e,n,i)}static upload(e,t,n,i){for(let r=0,a=t.length;r!==a;++r){const o=t[r],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,i)}}static seqWithValue(e,t){const n=[];for(let i=0,r=e.length;i!==r;++i){const a=e[i];a.id in t&&n.push(a)}return n}}function Kc(s,e,t){const n=s.createShader(e);return s.shaderSource(n,t),s.compileShader(n),n}const Q0=37297;let ev=0;function tv(s,e){const t=s.split(`
`),n=[],i=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=i;a<r;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const jc=new ke;function nv(s){$e._getMatrix(jc,$e.workingColorSpace,s);const e=`mat3( ${jc.elements.map(t=>t.toFixed(4))} )`;switch($e.getTransfer(s)){case Wr:return[e,"LinearTransferOETF"];case tt:return[e,"sRGBTransferOETF"];default:return we("WebGLProgram: Unsupported color space: ",s),[e,"LinearTransferOETF"]}}function Zc(s,e,t){const n=s.getShaderParameter(e,s.COMPILE_STATUS),r=(s.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";const a=/ERROR: 0:(\d+)/.exec(r);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`

`+r+`

`+tv(s.getShaderSource(e),o)}else return r}function iv(s,e){const t=nv(e);return[`vec4 ${s}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const sv={[el]:"Linear",[tl]:"Reinhard",[nl]:"Cineon",[Zr]:"ACESFilmic",[sl]:"AgX",[rl]:"Neutral",[il]:"Custom"};function rv(s,e){const t=sv[e];return t===void 0?(we("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+s+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const br=new L;function av(){$e.getLuminanceCoefficients(br);const s=br.x.toFixed(4),e=br.y.toFixed(4),t=br.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function ov(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Ls).join(`
`)}function lv(s){const e=[];for(const t in s){const n=s[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function cv(s,e){const t={},n=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const r=s.getActiveAttrib(e,i),a=r.name;let o=1;r.type===s.FLOAT_MAT2&&(o=2),r.type===s.FLOAT_MAT3&&(o=3),r.type===s.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:s.getAttribLocation(e,a),locationSize:o}}return t}function Ls(s){return s!==""}function Jc(s,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Qc(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const uv=/^[ \t]*#include +<([\w\d./]+)>/gm;function Yo(s){return s.replace(uv,dv)}const hv=new Map;function dv(s,e){let t=Ve[e];if(t===void 0){const n=hv.get(e);if(n!==void 0)t=Ve[n],we('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Yo(t)}const fv=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function eu(s){return s.replace(fv,pv)}function pv(s,e,t,n){let i="";for(let r=parseInt(e);r<parseInt(t);r++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function tu(s){let e=`precision ${s.precision} float;
...
#define LOW_PRECISION`),e}const mv={[Dr]:"SHADOWMAP_TYPE_PCF",[Ps]:"SHADOWMAP_TYPE_VSM"};function gv(s){return mv[s.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const _v={[yi]:"ENVMAP_TYPE_CUBE",[ns]:"ENVMAP_TYPE_CUBE",[Jr]:"ENVMAP_TYPE_CUBE_UV"};function vv(s){return s.envMap===!1?"ENVMAP_TYPE_CUBE":_v[s.envMapMode]||"ENVMAP_TYPE_CUBE"}const xv={[ns]:"ENVMAP_MODE_REFRACTION"};function Sv(s){return s.envMap===!1?"ENVMAP_MODE_REFLECTION":xv[s.envMapMode]||"ENVMAP_MODE_REFLECTION"}const yv={[Wu]:"ENVMAP_BLENDING_MULTIPLY",[sf]:"ENVMAP_BLENDING_MIX",[rf]:"ENVMAP_BLENDING_ADD"};function Mv(s){return s.envMap===!1?"ENVMAP_BLENDING_NONE":yv[s.combine]||"ENVMAP_BLENDING_NONE"}function Ev(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Tv(s,e,t,n){const i=s.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=gv(t),c=vv(t),u=Sv(t),d=Mv(t),h=Ev(t),f=ov(t),g=lv(r),S=i.createProgram();let m,p,v=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+p);const M=v+m+a,E=v+p+o,A=Kc(i,i.VERTEX_SHADER,M),w=Kc(i,i.FRAGMENT_SHADER,E);i.attachShader(S,A),i.attachShader(S,w),t.index0AttributeName!==void 0?i.bindAttribLocation(S,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(S,0,"position"),i.linkProgram(S);function C(R){if(s.debug.checkShaderErrors){const F=i.getProgramInfoLog(S)||"",k=i.getShaderInfoLog(A)||"",q=i.getShaderInfoLog(w)||"",O=F.trim(),G=k.trim(),U=q.trim();let re=!0,Q=!0;if(i.getProgramParameter(S,i.LINK_STATUS)===!1)if(re=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,S,A,w);else{const pe=Zc(i,A,"vertex"),ee=Zc(i,w,"fragment");Pe("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(S,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`};class Ai{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}const Ex=new _s(-1,1,1,-1,0,1);class Tx extends Vt{constructor(){super(),this.setAttribute("position",new bt([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new bt([0,2,0,0,2,0],2))}}const bx=new Tx;class hs{constructor(e){this._mesh=new vt(bx,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,Ex)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}}class Pl extends Ai{constructor(e,t="tDiffuse"){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof yt?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Qr.clone(e.uniforms),this.material=new yt({name:e.name!==void 0?e.name:"unspecified",defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new hs(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}}class cu extends Ai{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){const i=e.getContext(),r=e.state;r.buffers.color.setMask(!1),r.buffers.depth.setMask(!1),r.buffers.color.setLocked(!0),r.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),r.buffers.stencil.setTest(!0),r.buffers.stencil.setOp(i.REPLACE,i.REPLACE,i.REPLACE),r.buffers.stencil.setFunc(i.ALWAYS,a,4294967295),r.buffers.stencil.setClear(o),r.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),r.buffers.color.setLocked(!1),r.buffers.depth.setLocked(!1),r.buffers.color.setMask(!0),r.buffers.depth.setMask(!0),r.buffers.stencil.setLocked(!1),r.buffers.stencil.setFunc(i.EQUAL,1,4294967295),r.buffers.stencil.setOp(i.KEEP,i.KEEP,i.KEEP),r.buffers.stencil.setLocked(!0)}}class Ax extends Ai{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}}class wx{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){const n=e.getSize(new Be);this._width=n.width,this._height=n.height,t=new Bt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:Qt}),t.texture.name="EffectComposer.rt1"}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Pl(kr),this.copyPass.material.blending=bn,this.timer=new qp}swapBuffers(){const e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){const t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());const t=this.renderer.getRenderTarget();let n=!1;for(let i=0,r=this.passes.length;i<r;i++){const a=this.passes[i];if(a.enabled!==!1){if(a.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(i),a.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),a.needsSwap){if(n){const o=this.renderer.getContext(),l=this.renderer.state.buffers.stencil;l.setFunc(o.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),l.setFunc(o.EQUAL,1,4294967295)}this.swapBuffers()}cu!==void 0&&(a instanceof cu?n=!0:a instanceof Ax&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){const t=this.renderer.getSize(new Be);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;const n=this._width*this._pixelRatio,i=this._height*this._pixelRatio;this.renderTarget1.setSize(n,i),this.renderTarget2.setSize(n,i);for(let r=0;r<this.passes.length;r++)this.passes[r].setSize(n,i)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}}const Ar={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
...
`;class Px extends Ai{constructor(t,n,i,r={}){super();Le(this,"pixelSize");Le(this,"scene");Le(this,"camera");Le(this,"normalEdgeStrength");Le(this,"depthEdgeStrength");Le(this,"pixelatedMaterial");Le(this,"_resolution",new Be);Le(this,"_renderResolution",new Be);Le(this,"_normalMaterial",new Ep);Le(this,"_beautyRenderTarget");Le(this,"_normalRenderTarget");Le(this,"_fsQuad");this.pixelSize=t,this.scene=n,this.camera=i,this.normalEdgeStrength=r.normalEdgeStrength??.3,this.depthEdgeStrength=r.depthEdgeStrength??.4,this.pixelatedMaterial=new yt({uniforms:{tDiffuse:{value:null},tDepth:{value:null},tNormal:{value:null},resolution:{value:new ft},normalEdgeStrength:{value:this.normalEdgeStrength},depthEdgeStrength:{value:this.depthEdgeStrength}},vertexShader:Cx,fragmentShader:Ix}),this._beautyRenderTarget=new Bt(1,1,{format:Wt,type:Qt});const a=new as(1,1);a.minFilter=rt,a.magFilter=rt,this._beautyRenderTarget.depthTexture=a,this._beautyRenderTarget.texture.minFilter=rt,this._beautyRenderTarget.texture.magFilter=rt,this._normalRenderTarget=new Bt(1,1),this._normalRenderTarget.texture.minFilter=rt,this._normalRenderTarget.texture.magFilter=rt,this._normalRenderTarget.texture.type=Qt,this._fsQuad=new hs(this.pixelatedMaterial)}setSize(t,n){this._resolution.set(t,n);const i=t/this.pixelSize|0,r=n/this.pixelSize|0;this._renderResolution.set(i,r),this._beautyRenderTarget.setSize(i,r),this._normalRenderTarget.setSize(i,r),this._fsQuad.material.uniforms.resolution.value.set(i,r,1/i,1/r)}setPixelSize(t){this.pixelSize=t,this.setSize(this._resolution.x,this._resolution.y)}getDepthTexture(){return this._beautyRenderTarget.depthTexture}getRenderResolution(){return{width:this._renderResolution.x,height:this._renderResolution.y}}render(t,n){const i=this._fsQuad.material.uniforms;i.normalEdgeStrength.value=this.normalEdgeStrength,i.depthEdgeStrength.value=this.depthEdgeStrength,t.setRenderTarget(this._beautyRenderTarget);const r=this.scene.background;this.scene.background=null;const a=new Ne,o=t.getClearAlpha();t.getClearColor(a),t.setClearColor(0,0),t.render(this.scene,this.camera),t.setClearColor(a,o),this.scene.background=r;const l=this.scene.overrideMaterial;t.setRenderTarget(this._normalRenderTarget),this.scene.overrideMaterial=this._normalMaterial,t.render(this.scene,this.camera),this.scene.overrideMaterial=l,i.tDiffuse.value=this._beautyRenderTarget.texture,i.tDepth.value=this._beautyRenderTarget.depthTexture,i.tNormal.value=this._normalRenderTarget.texture,this.renderToScreen?t.setRenderTarget(null):(t.setRenderTarget(n),this.clear&&t.clear()),this._fsQuad.render(t)}dispose(){this._beautyRenderTarget.dispose(),this._normalRenderTarget.dispose(),this.pixelatedMaterial.dispose(),this._normalMaterial.dispose(),this._fsQuad.dispose()}}const Dx=`varying vec2 vUv;

void main() {
  vUv = uv;
  gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
}
`,Lx=`uniform sampler2D tDiffuse;
uniform sampler2D tDepth;
...
`,Bx={name:"VignetteShader",uniforms:{tDiffuse:{value:null},offset:{value:1},darkness:{value:1.2}},vertexShader:Fx,fragmentShader:Ox},kx=`varying vec2 vUv;
void main() {
  vUv = uv;
  gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
}
`,zx=`// Fork of https://www.shadertoy.com/view/Wt33Wf (Cyber Fuji 2020), no sun.
precision highp float;
uniform float uTime;
...
`;function Vx(s){return new yt({uniforms:s,vertexShader:kx,fragmentShader:zx,depthWrite:!1,depthTest:!1})}function Gx(){return{uTime:{value:0},uColorCurrent:{value:new L(.36,.53,.73)},uColorPrev:{value:new L(.36,.53,.73)},uColorMix:{value:1},uShake:{value:0},uResolution:{value:new Be(640,360)}}}class Hx extends Ai{constructor(t){super();Le(this,"_uniforms");Le(this,"_fsQuad");Le(this,"_backgroundRT");Le(this,"_copyQuad");Le(this,"_copyMaterial");this._uniforms=t,this._fsQuad=new hs(Vx(t));const n=t.uResolution.value.x,i=t.uResolution.value.y;this._backgroundRT=new Bt(n,i,{minFilter:St,magFilter:St}),this._copyMaterial=new yt({uniforms:Qr.clone(kr.uniforms),vertexShader:kr.vertexShader,fragmentShader:kr.fragmentShader}),this._copyQuad=new hs(this._copyMaterial),this.clear=!0,this.needsSwap=!0}getBackgroundTexture(){return this._backgroundRT.texture}setSize(t,n){this._uniforms.uResolution.value.set(t,n),this._backgroundRT.setSize(t,n)}render(t,n){t.setRenderTarget(n),this.clear&&t.clear(),this._fsQuad.render(t),this._copyMaterial.uniforms.tDiffuse.value=n.texture,t.setRenderTarget(this._backgroundRT),t.clear(),this._copyQuad.render(t)}dispose(){this._fsQuad.dispose(),this._copyQuad.dispose(),this._copyMaterial.dispose(),this._backgroundRT.dispose()}}const Wx=`varying vec2 vUv;
void main() {
  vUv = uv;
  gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
}
...
`;class qx extends Ai{constructor(t){super();Le(this,"_material");Le(this,"_fsQuad");Le(this,"_getBackgroundTexture");this._getBackgroundTexture=t,this._material=new yt({uniforms:{tScene:{value:null},tBackground:{value:null}},vertexShader:Wx,fragmentShader:Xx,depthWrite:!1,depthTest:!1}),this._fsQuad=new hs(this._material),this.needsSwap=!0}render(t,n,i){this._material.uniforms.tScene.value=i.texture,this._material.uniforms.tBackground.value=this._getBackgroundTexture(),t.setRenderTarget(n),this.clear&&t.clear(),this._fsQuad.render(t)}dispose(){this._fsQuad.dispose(),this._material.dispose()}}function Yx(s,e,t,n){const{width:i,height:r}=n,a=n.pixelSize??4,o=n.normalEdgeStrength??.3,l=n.depthEdgeStrength??.4,c=Gx(),u=new Hx(c),d=new Bt(i,r,{type:Qt,format:Wt}),h=new wx(s,d);h.addPass(u);const f=new Px(a,e,t,{normalEdgeStrength:o,depthEdgeStrength:l});h.addPass(f);const g=new Ux(f.getDepthTexture(),()=>f.getRenderResolution()),S=Math.max(.001,Math.min(.1,n.edgeThreshold??.005));g.uniforms.edgeThreshold.value=S,h.addPass(g);const m=new qx(()=>u.getBackgroundTexture());h.addPass(m);const p=new Pl(Bx);return p.uniforms.offset.value=0,p.uniforms.darkness.value=1.2,h.addPass(p),h.addPass(new Rx),h.setSize(i,r),h.setPixelRatio(1),[h.renderTarget1,h.renderTarget2].forEach(v=>{v.texture.magFilter=rt,v.texture.minFilter=rt}),{composer:h,backgroundUniforms:c}}function $x(s,e,t){s.setSize(e,t),s.setPixelRatio(1)}function Kx(s){const e=s.debug;e&&(e.onShaderError=(t,n,i,r)=>{const a=(t.getProgramInfoLog(n)||"").trim(),o=(t.getShaderInfoLog(i)||"").trim(),l=(t.getShaderInfoLog(r)||"").trim(),c=t.getShaderSource(i)||"",u=t.getShaderSource(r)||"",h=["--- THREE Shader Error (detailed) ---",`VALIDATE_STATUS: ${t.getProgramParameter(n,t.VALIDATE_STATUS)}`,"","Program Info Log:",a||"(empty)","","Vertex Shader Info Log:",o||"(empty — driver did not return details)","","Fragment Shader Info Log:",l||"(empty — driver did not return details)"];u&&(h.push("","Fragment shader source (first 80 lines):"),u.split(`
...
`))})}const jx=.85,Zx=.1;function Jx(s){return new Ys({color:s,roughness:jx,metalness:Zx})}const Qx=8947848,eS=.6,tS=.2;function nS(){return new Ys({color:Qx,roughness:eS,metalness:tS})}const iS=`varying vec3 vNormal;
...
`;function uu(s){return{r:(s>>16&255)/255,g:(s>>8&255)/255,b:(s&255)/255}}function hu(s,e){return{uFillColor:{value:uu(s)},uOutlineColor:{value:uu(e)},uFillOpacity:{value:.6},uEdgeThreshold:{value:.65},uEdgeWidth:{value:.28}}}const wr={vertexShader:iS,fragmentShader:sS},rS=.2,Ei={empty:2764354,neutral:4212832,p1:6129338,p2:11546716};function Zh(s){return!s||s.type==="neutral"?s?"neutral":"empty":s.owner===1?"p1":"p2"}function aS(){const s=new ds(.9,.15,.9),e=Jx(Ei.neutral);return new vt(s,e)}const du=-8,oS=8,fu=.5,lS=1.5,pu=16777215,cS=11206570,uS=.11,hS=.4;let Rr=null,Xa=null,qa=null;function dS(s){Rr||(Rr=new Al(uS,16,12));const e=s===1?Ei.p1:Ei.p2;if(s===1){if(!Xa){const t=hu(e,pu);Xa=new yt({uniforms:t,vertexShader:wr.vertexShader,fragmentShader:wr.fragmentShader,transparent:!0,depthWrite:!0,side:an,extensions:{derivatives:!0}})}return new vt(Rr,Xa)}if(!qa){const t=hu(e,pu);qa=new yt({uniforms:t,vertexShader:wr.vertexShader,fragmentShader:wr.fragmentShader,transparent:!0,depthWrite:!0,side:an,extensions:{derivatives:!0}})}return new vt(Rr,qa)}function fS(s,e){const t=s%e,n=Math.floor(s/e),i=new Xt;i.position.set(t,0,n),i.userData={entityId:s,targetX:t,targetY:n,progress:1},i.add(aS());const r=new Xt;return r.position.y=.7,i.add(r),i}function pS(s){const e=new Xt;for(let t=0;t<s*s;t++)e.add(fS(t,s));return e}function mS(s){s.traverse(e=>{"raycast"in e&&typeof e.raycast=="function"&&(e.raycast=()=>{})})}function gS(s,e){if(s.clear(),e){const t=e.clone(!0);mS(t),s.add(t)}}function Jh(s){return 1-(1-s)**3}function Bn(s,e,t){e.children.forEach(n=>{const i=n,r=i.userData,a=i.children[0],o=i.children[1];if(!o)return;const l=s.getComponent(r.entityId,ht),c=s.hasComponent(r.entityId,Mi);a.visible=!c,c||a.material.color.setHex(Ei[Zh(l)]??Ei.neutral);const u=l&&l.type!=="neutral"&&t?t[l.type]:null;gS(o,u);const d=s.getComponent(r.entityId,dt);if(!d)return;const h=d.x,f=d.y,g=r.targetX!==h||r.targetY!==f;r.targetX=h,r.targetY=f,g&&(r.startX=i.position.x,r.startZ=i.position.z,r.progress=0)})}function _S(s,e){s.children.forEach(t=>{const n=t,i=n.userData;if(i.progress===void 0||i.progress>=1)return;i.progress=Math.min(1,i.progress+e/rS);const r=Jh(i.progress);n.position.x=(i.startX??n.position.x)+((i.targetX??n.position.x)-(i.startX??n.position.x))*r,n.position.z=(i.startZ??n.position.z)+((i.targetY??n.position.z)-(i.startZ??n.position.z))*r})}function vS(s){s.children.forEach(e=>{const t=e,n=t.userData;n.dropStartY=du+Math.random()*(oS-du),n.dropStartY<1&&(n.dropStartY=1),n.dropDuration=fu+Math.random()*(lS-fu),n.dropProgress=0,t.position.y=n.dropStartY})}function xS(s,e){s.children.forEach(t=>{const n=t,i=n.userData;if(i.dropProgress===void 0||i.dropProgress>=1)return;i.dropProgress=Math.min(1,i.dropProgress+e/(i.dropDuration??.3));const r=Jh(i.dropProgress);n.position.y=(i.dropStartY??0)*(1-r),i.dropProgress===1&&(n.position.y=0)})}function SS(s){s.children.forEach(e=>{const t=e,n=t.userData;t.position.y=0,n.dropProgress=1})}function yS(s){for(const e of s.children)if((e.userData.dropProgress??0)<1)return!1;return!0}function MS(){return new Xt}function Rs(s,e,t){for(;s.children.length>0;)s.remove(s.children[0]);if(!(e.length===0||t===void 0))for(const n of e){const i=dS(t);i.position.set(n.x,hS,n.y),s.add(i)}}function ES(s,e,t){return e===void 0||t===void 0?!1:s.has(`${e},${t}`)}function Xi(s,e,t){const n=new Set(t.map(i=>`${i.x},${i.y}`));e.children.forEach(i=>{const r=i,a=r.userData;if(a.entityId===void 0)return;const o=r.children[0];if(!(o instanceof vt))return;const l=o,c=a.entityId,u=s.hasComponent(c,Mi);l.visible=!u;const d=s.getComponent(c,ht);if(!u){const h=Ei[Zh(d)]??Ei.neutral,g=ES(n,a.targetX,a.targetY)?cS:h;l.material.color.setHex(g)}})}function TS(s,e){var n;let t=s;for(;t&&t.parent!==e;)t=t.parent;return t&&((n=t.userData)==null?void 0:n.entityId)!==void 0?t:null}function bS(s,e,t){for(const n of s.children){const i=n,r=i.userData;if(r.targetX===e&&r.targetY===t){const a=i.children[1];if(!a)throw new Error("Board cell has no unit slot");return a}}throw new Error(`Unit slot not found at (${e}, ${t})`)}const AS=`varying vec2 vUv;

void main() {
  vUv = uv;
  gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
}
`,wS=`#define PI 3.1415926535897932384626433832795
...
`,mu={uniforms:{uColor:{value:new L(1,1,1)}},vertexShader:AS,fragmentShader:wS},RS=`varying vec2 vUv;

void main() {
  vUv = uv;
  gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
}
`,CS=`uniform vec3 uColor;
uniform float uAlpha;
varying vec2 vUv;
...
`,gu={uniforms:{uColor:{value:new L(1,1,1)}},vertexShader:RS,fragmentShader:CS};function IS(s){return new L((s>>16&255)/255,(s>>8&255)/255,(s&255)/255)}const PS={1:6129338,2:11546716};function Qh(s){return IS(PS[s])}const ed=.6,td=.35,nd=.15;function DS(s){const e=new bi(3,3),t=new yt({uniforms:{uColor:{value:Qh(s).clone()},uAlpha:{value:0},uTime:{value:0},uTrailAngle:{value:Math.PI/1.5}},vertexShader:mu.vertexShader,fragmentShader:mu.fragmentShader,transparent:!0,depthWrite:!1,side:Zt});return new vt(e,t)}function LS(s){const e=new bi(.8,.8),t=new yt({uniforms:{uColor:{value:Qh(s).clone()},uAlpha:{value:1}},vertexShader:gu.vertexShader,fragmentShader:gu.fragmentShader,transparent:!0,depthWrite:!1,side:Zt});return new vt(e,t)}let id=null;function NS(){const s=new bi(.25,.9),e=new ti({map:id,transparent:!0,side:Zt,depthWrite:!1});return new vt(s,e)}function US(s){return id=s,new Xt}let ct=null;function FS(s,e,t,n,i){Dl(s);const r=ed,a=DS(t);a.position.set(e.x,.1,e.y),a.rotation.x=-Math.PI/2,s.add(a),ct={type:"sword",startTime:n,endTime:n+r,mesh:a,owner:t}}function OS(s,e,t,n,i,r,a){Dl(s);const o=td,l=nd,c=[],u=[];for(const d of t){const h=NS();h.position.set(e.x,.5,e.y),s.add(h),c.push(h);const f=LS(n);f.position.set(d.x,.4,d.y),f.rotation.x=-Math.PI/2,f.visible=!1,s.add(f),u.push(f)}ct={type:"arrow",startTime:i,endTime:i+o+l,flightDuration:o,hitDuration:l,from:e,targets:t,owner:n,arrowMeshes:c,hitMeshes:u}}function Dl(s){ct&&(ct.type==="sword"?(s.remove(ct.mesh),ct.mesh.geometry.dispose(),ct.mesh.material.dispose()):(ct.arrowMeshes.forEach(e=>{s.remove(e),e.geometry.dispose(),e.material.dispose()}),ct.hitMeshes.forEach(e=>{s.remove(e),e.geometry.dispose(),e.material.dispose()})),ct=null)}function BS(s,e,t){return{x:s.x+(e.x-s.x)*t,y:s.y+(e.y-s.y)*t}}function kS(s,e){if(!ct)return!1;const t=e>=ct.endTime;if(ct.type==="sword"){const n=e-ct.startTime,i=ct.endTime-ct.startTime,r=Math.min(1,n/i),a=.6*4*r*(1-r),o=ct.mesh.material;o.uniforms.uAlpha.value=a,o.uniforms.uTime.value=r}else{const n=e-ct.startTime,i=Math.min(1,n/ct.flightDuration),r=ct.flightDuration,a=n>=r,o=new gn(-Math.PI/2,0,0,"YXZ");for(let l=0;l<ct.arrowMeshes.length;l++){const c=ct.arrowMeshes[l],u=ct.targets[l],d=BS(ct.from,u,i),h=u.x-ct.from.x,f=u.y-ct.from.y;c.position.set(d.x,.15,d.y),c.visible=!a,o.y=Math.atan2(h,-f),c.quaternion.setFromEuler(o)}for(const l of ct.hitMeshes){l.visible=a;const c=n-r,u=Math.max(0,1-c/ct.hitDuration);l.material.uniforms.uAlpha.value=u}}return t?(Dl(s),!0):!1}const zS=ed,VS=td+nd,GS=.7,HS=.12;function WS(s,e,t){const n=[],i=[],r=[];for(let c=0;c<=16;c++){const u=c/16,d=u*s;n.push(d);const h=4*u*(1-u),f=1-e*h,g=1+t*h;i.push(g,f,g);const S=GS-HS*h;r.push(0,S,0)}const o=new si(".scale",n,i),l=new si(".position",n,r);return new Kr("attack_squash",s,[o,l])}const XS=.6,qS=.3,YS=.35,$S={attack_squash:WS(XS,qS,YS)};function KS(s){const e=$S[s];if(!e)throw new Error(`Unknown animation clip: ${s}`);return e}const _u=new WeakMap;function jS(s){let e=_u.get(s);return e||(e=new am(s),_u.set(s,e)),e}function ZS(s,e,t){const n=s.query([Ji,dt,ht]);for(const i of n){const r=s.getComponent(i,Ji),a=s.getComponent(i,dt);if(!r.playing||!a)continue;const o=bS(e,a.x,a.y),l=KS(r.playing.clipId),c=jS(o),u=c.clipAction(l),d=t-r.playing.startTime;if(u.play(),u.time=Math.min(d,l.duration),c.update(0),d>=l.duration){const h={clipIds:r.clipIds};s.addComponent(i,Ji,h)}}}class JS{constructor(){Le(this,"nextId",0);Le(this,"entities",new Set);Le(this,"components",new Map);Le(this,"systems",[])}createEntity(){const e=this.nextId++;return this.entities.add(e),e}removeEntity(e){this.entities.delete(e),this.components.forEach(t=>t.delete(e))}addComponent(e,t,n){let i=this.components.get(t);i||(i=new Map,this.components.set(t,i)),i.set(e,n)}getComponent(e,t){var n;return(n=this.components.get(t))==null?void 0:n.get(e)}hasComponent(e,t){var n;return((n=this.components.get(t))==null?void 0:n.has(e))??!1}removeComponent(e,t){var n;(n=this.components.get(t))==null||n.delete(e)}query(e){var r;if(e.length===0)return[];if(e.length===1){const[a]=e;return[...((r=this.components.get(a))==null?void 0:r.keys())??[]]}const t=e.map(a=>this.components.get(a));if(t.some(a=>a===void 0))return[];const n=t.reduce((a,o)=>o.size<a.size?o:a),i=e.find(a=>this.components.get(a)===n);return[...n.keys()].filter(a=>e.every(o=>o===i||this.hasComponent(a,o)))}addSystem(e){this.systems.push(e)}tick(e){this.systems.forEach(t=>t(this,e))}getEntities(){return new Set(this.entities)}clear(){this.entities.clear(),this.components.forEach(e=>e.clear()),this.nextId=0}}function sa(s,e){if(s.x===e.x&&s.y===e.y)return null;const t=s.y===e.y,n=s.x===e.x;if(!t&&!n)return null;const i=t?{x:Math.sign(e.x-s.x),y:0}:{x:0,y:Math.sign(e.y-s.y)},r=[{...s}];let a={x:s.x+i.x,y:s.y+i.y};for(;a.x!==e.x||a.y!==e.y;)r.push({...a}),a={x:a.x+i.x,y:a.y+i.y};return r.push({...e}),r}function Us(s){const e=$s(s);if(!e)return[];const t=jt(s),n=(t==null?void 0:t.boardSize)??0,i=new Set;for(let r=0;r<n;r++){const a=Ht(s,r,e.y);a!==void 0&&!s.hasComponent(a,Mi)&&i.add(a)}for(let r=0;r<n;r++){const a=Ht(s,e.x,r);a!==void 0&&!s.hasComponent(a,Mi)&&i.add(a)}return[...i]}function $s(s){const e=s.query([dt,Mi])[0];return e!==void 0?s.getComponent(e,dt):void 0}function Ht(s,e,t){return s.query([dt]).find(i=>{const r=s.getComponent(i,dt);return r.x===e&&r.y===t})}function Tn(s){return s.query([Tt])[0]}function jt(s){const e=Tn(s);return e!==void 0?s.getComponent(e,Tt):void 0}function QS(s,e){const t=$s(s);if(!t)return!1;const n=s.getComponent(e,dt);if(!n||s.hasComponent(e,Mi))return!1;const i=sa(t,n);if(!i||i.length<2)return!1;const r=i.map(o=>Ht(s,o.x,o.y)).filter(o=>o!==void 0);if(r.length!==i.length)return!1;const a=r[0];for(let o=i.length-1;o>=1;o--)s.addComponent(r[o],dt,{...i[o-1]}),s.addComponent(r[o],jr,{});return s.addComponent(a,dt,{...i[i.length-1]}),!0}function ey(s,e){const t=Tn(s);if(t===void 0)return;const n=s.getComponent(t,Tt);if((n==null?void 0:n.pendingShiftTileId)===void 0)return;const i=n.pendingShiftTileId;QS(s,i),s.addComponent(t,Tt,{...n,pendingShiftTileId:void 0})}const Ll=5;function sd(s,e,t,n,i,r){const a=[];if(e==="commander"||e==="neutral")return a;if(e==="archer"){const o=Math.min(Ll,i);for(const{dx:l,dy:c}of Il)for(let u=1;u<=o;u++){const d=t+l*u,h=n+c*u;if(d<0||d>=i||h<0||h>=i)break;a.push({x:d,y:h});const f=r(d,h);if(f===void 0)continue;const g=s.getComponent(f,ht);if(!g||g.owner!==0)break}}else if(e==="swordsman")for(const{dx:o,dy:l}of bh){const c=t+o,u=n+l;c>=0&&c<i&&u>=0&&u<i&&a.push({x:c,y:u})}return a}function Ko(s,e){const t=s.getComponent(e,ht),n=s.getComponent(e,dt);if(!t||!n||t.type==="commander"||t.type==="neutral")return[];const i=jt(s),r=(i==null?void 0:i.boardSize)??6;return sd(s,t.type,n.x,n.y,r,(a,o)=>Ht(s,a,o))}function ty(s,e,t,n,i){const r=jt(s),a=(r==null?void 0:r.boardSize)??6;return sd(s,e,t,n,a,i??((l,c)=>Ht(s,l,c)))}function Nl(s,e){return s!==0&&s!==e}function rd(s,e,t,n,i,r,a,o){for(let l=1;l<=o;l++){const c=e+n*l,u=t+i*l;if(c<0||c>=a||u<0||u>=a)break;const d=Ht(s,c,u);if(d===void 0)continue;const h=s.getComponent(d,ht);if(!h)break;if(h.owner!==0){if(Nl(h.owner,r))return d;break}}}function ny(s,e,t,n,i){const r=[],a=od(s,e,t);for(const o of a){const l=s.getComponent(o,ht);if(!l||!Nl(l.owner,n))continue;const c=s.getComponent(o,dt);c&&r.push({x:c.x,y:c.y})}return r}function iy(s,e,t,n,i){const r=[],a=Math.min(Ll,i.boardSize);for(const{dx:o,dy:l}of Il){const c=rd(s,e,t,o,l,n,i.boardSize,a);if(c===void 0)continue;const u=s.getComponent(c,dt);u&&r.push({x:u.x,y:u.y})}return r}function sy(s){const e=s.query([jr,ht,dt]),t=Tn(s);if(!t)return null;const n=s.getComponent(t,Tt);if(!n)return null;for(const i of e){const r=s.getComponent(i,ht);if(r.type==="commander"||r.type==="neutral")continue;const a=s.getComponent(i,dt),o=r.owner,l=r.type==="swordsman"?ny(s,a.x,a.y,o,n.boardSize):r.type==="archer"?iy(s,a.x,a.y,o,n):[];if(l.length!==0)return{type:r.type,attackerPos:{x:a.x,y:a.y},targets:l,owner:o}}return null}const ry=1;function ay(s,e){const t=s.getComponent(e,Tt);t&&s.addComponent(e,Tt,{...t,damageDealtThisTick:!0})}function ad(s,e,t,n,i){if(t===n)return null;const r=s.getComponent(t,ht);if(!r||r.type==="neutral"||r.owner===i)return null;const a=Math.max(0,r.health-ry);if(ay(s,e),a>0)return s.addComponent(t,ht,{...r,health:a}),null;const o=r.type==="commander";return s.addComponent(t,ht,{type:"neutral",owner:0,health:0,maxHealth:0}),o?r:null}function od(s,e,t,n){return bh.map(({dx:r,dy:a})=>Ht(s,e+r,t+a)).filter(r=>r!==void 0)}function ld(s,e,t,n){return console.warn(`[смерть] Убит ${s.type} игрока ${s.owner} (атаковал ${e.type} игрока ${t})`),s.type==="commander"?(console.warn(`[смерть] Командир убит. Игра окончена, победитель: игрок ${t}`),n.gameOver=!0,n.winner=t,!0):!1}function oy(s,e,t,n,i,r,a){const o=n.owner,l=Math.min(Ll,a.boardSize);for(const{dx:c,dy:u}of Il){const d=rd(s,i,r,c,u,o,a.boardSize,l);if(d===void 0)continue;const h=ad(s,e,d,t,o);if(h&&ld(h,n,o,a))return!0}return!1}function ly(s,e,t,n,i,r,a){const o=n.owner,l=od(s,i,r);for(const c of l){const u=s.getComponent(c,ht);if(!u||!Nl(u.owner,o))continue;const d=ad(s,e,c,t,o);if(d&&ld(d,n,o,a))return!0}return!1}function cy(s,e){cd(s)}function cd(s){const e=Tn(s);if(!e)return;const t=s.getComponent(e,Tt);if(t.skipAttackResolution)return;const n=s.query([jr,ht,dt]);for(const i of n){s.removeComponent(i,jr);const r=s.getComponent(i,ht);if(r.type==="commander"||r.type==="neutral")continue;const a=s.getComponent(i,dt);if(r.type==="archer"){if(oy(s,e,i,r,a.x,a.y,t)){s.addComponent(e,Tt,{...t,damageDealtThisTick:!0});return}}else if(r.type==="swordsman"&&ly(s,e,i,r,a.x,a.y,t)){s.addComponent(e,Tt,{...t,damageDealtThisTick:!0});return}}}function jo(s){const e=Tn(s);if(e===void 0)return;const t=s.getComponent(e,Tt),n={...t,currentPlayer:t.currentPlayer===1?2:1};s.addComponent(e,Tt,n)}function uy(s,e){}const vu=2,xu=1,hy=100,dy=10,fy=100;function ud(s){return`${s.x},${s.y}`}function py(s,e){const t=$s(s),n=s.getComponent(e,dt);if(!t||!n)return null;const i=sa(t,n);if(!i||i.length<2)return null;const r=i.map(l=>Ht(s,l.x,l.y)).filter(l=>l!==void 0);if(r.length!==i.length)return null;const a=new Map,o=r[0];a.set(o,{...i[i.length-1]});for(let l=1;l<i.length;l++)a.set(r[l],{...i[l-1]});for(const l of s.query([dt]))a.has(l)||a.set(l,s.getComponent(l,dt));return a}function my(s){const e=new Map;return s.forEach((t,n)=>e.set(ud(t),n)),e}function gy(s,e){const t=py(s,e);if(!t)return-1/0;const n=my(t),i=(u,d)=>n.get(ud({x:u,y:d})),r=$s(s),o=sa(r,s.getComponent(e,dt)).map(u=>Ht(s,u.x,u.y)).filter(u=>u!==void 0);let l=0;for(let u=1;u<o.length;u++){const d=o[u],h=s.getComponent(d,ht);if(!h||h.owner!==vu||h.type!=="archer"&&h.type!=="swordsman")continue;const f=t.get(d),g=ty(s,h.type,f.x,f.y,i);for(const S of g){const m=i(S.x,S.y);if(m===void 0)continue;const p=s.getComponent(m,ht);!p||p.owner!==xu||(l+=p.type==="commander"?hy:dy)}}const c=s.query([ht,dt]).find(u=>{var d,h;return((d=s.getComponent(u,ht))==null?void 0:d.type)==="commander"&&((h=s.getComponent(u,ht))==null?void 0:h.owner)===vu});if(c!==void 0){const u=t.get(c);for(const d of s.query([ht,dt])){const h=s.getComponent(d,ht);if(!h||h.owner!==xu||h.type!=="archer"&&h.type!=="swordsman")continue;Ko(s,d).some(g=>g.x===u.x&&g.y===u.y)&&(l-=fy)}}return l}function _y(s,e){let t=Us(s);if(e!==void 0&&(t=t.filter(r=>r!==e)),t.length===0)return null;let n=-1/0;const i=[];for(const r of t){const a=gy(s,r);a>n?(n=a,i.length=0,i.push(r)):a===n&&i.push(r)}return i[Math.floor(Math.random()*i.length)]}function Su(s,e){const t=_y(s,e);if(t===null){jo(s);return}const n=Tn(s),i=jt(s);n!==void 0&&i?(s.addComponent(n,Tt,{...i,pendingShiftTileId:t,skipAttackResolution:!0}),s.tick(0)):jo(s)}const vy={commander:"КОМАНДИР",archer:"ЛУЧНИК",swordsman:"МЕЧНИК"},xy={commander:"CMD",archer:"ARC",swordsman:"SWD"};function Sy(s){return Si(s).avatarImg}function yy(s,e){if(e.owner!==1&&e.owner!==2)return null;const t=e.type,n=vy[t]??"",i=xy[t]??"",r=Sy(t);return{entityId:s,type:e.type,owner:e.owner,health:e.health,maxHealth:e.maxHealth,label:n,avatar:i,avatarImg:r}}function My(s){const e=s.query([ht]),t=[],n=[];for(const r of e){const a=s.getComponent(r,ht);if(!a)continue;const o=yy(r,a);if(!o)continue;const l=s.getComponent(r,dt),c={...o,y:(l==null?void 0:l.y)??0,x:(l==null?void 0:l.x)??0};a.owner===1?t.push(c):n.push(c)}const i=r=>r.sort((a,o)=>a.type==="commander"?-1:o.type==="commander"?1:a.y-o.y||a.x-o.x);return i(t),i(n),{p1:t.map(({entityId:r,type:a,owner:o,health:l,maxHealth:c,label:u,avatar:d,avatarImg:h})=>({entityId:r,type:a,owner:o,health:l,maxHealth:c,label:u,avatar:d,avatarImg:h})),p2:n.map(({entityId:r,type:a,owner:o,health:l,maxHealth:c,label:u,avatar:d,avatarImg:h})=>({entityId:r,type:a,owner:o,health:l,maxHealth:c,label:u,avatar:d,avatarImg:h}))}}function Ey(s,e,t){const n=t?"hp-pip red":"hp-pip";let i="";for(let r=0;r<e;r++)i+=`<div class="${n}${r>=s?" empty":""}"></div>`;return i}function yu(s,e){const t=e?" flex-row-reverse":"",n=s.type==="commander"?"border-game-gold text-game-gold":e?"text-game-red":"text-game-blue",i=e?"flex gap-1 justify-end":"flex gap-1",r=Ey(s.health,s.maxHealth,e),a=e?"":" avatar-flip-y";return`<div class="unit-card${t}" data-entity-id="${s.entityId}">
  ...
  </div>`}function Jn(s){const e=document.getElementById("army-p1-list"),t=document.getElementById("army-p2-list");if(!e||!t)return;const{p1:n,p2:i}=My(s);e.innerHTML=n.map(r=>yu(r,!1)).join(""),t.innerHTML=i.map(r=>yu(r,!0)).join("")}const Ty="gameOver";function by(s,e,t){return s!==Ty?{visible:!1,variant:null,title:"",subtitle:""}:t==="pvp"?e===1?{visible:!0,variant:"p1",title:"ПОБЕДА ИГРОКА 1",subtitle:"Командир противника уничтожен"}:e===2?{visible:!0,variant:"p2",title:"ПОБЕДА ИГРОКА 2",subtitle:"Командир противника уничтожен"}:{visible:!0,variant:null,title:"ИГРА ОКОНЧЕНА",subtitle:""}:e===1?{visible:!0,variant:"victory",title:"ПОБЕДА",subtitle:"Вы уничтожили командира противника"}:e===2?{visible:!0,variant:"defeat",title:"ПОРАЖЕНИЕ",subtitle:"Ваш командир уничтожен"}:{visible:!0,variant:null,title:"ИГРА ОКОНЧЕНА",subtitle:""}}const zr={colorTransitionDuration:.5,shakeDuration:.15},mi={width:640,height:480,pixelSize:4,normalEdgeStrength:.3,depthEdgeStrength:.4,edgeThreshold:.005,background:zr},Mu={board:Ns,render:mi},Ay=us("/config/app.json");function wy(s){if(!s||typeof s!="object")return zr;const e=s,t=Number(e==null?void 0:e.colorTransitionDuration),n=Number(e==null?void 0:e.shakeDuration);return{colorTransitionDuration:Number.isFinite(t)&&t>0?t:zr.colorTransitionDuration,shakeDuration:Number.isFinite(n)&&n>0?n:zr.shakeDuration}}function Ry(s){if(!s||typeof s!="object")return mi;const e=s,t=Number(e==null?void 0:e.width),n=Number(e==null?void 0:e.height);if(!Number.isFinite(t)||!Number.isFinite(n)||t<1||n<1)return mi;const i=Number(e==null?void 0:e.pixelSize),r=Number(e==null?void 0:e.normalEdgeStrength),a=Number(e==null?void 0:e.depthEdgeStrength),o=Number(e==null?void 0:e.edgeThreshold),l=wy(e==null?void 0:e.background),c=Number.isFinite(o)&&o>=.001&&o<=.1?o:mi.edgeThreshold;return{width:Math.floor(t),height:Math.floor(n),pixelSize:Number.isFinite(i)&&i>=1?Math.floor(i):mi.pixelSize,normalEdgeStrength:Number.isFinite(r)?r:mi.normalEdgeStrength,depthEdgeStrength:Number.isFinite(a)?a:mi.depthEdgeStrength,edgeThreshold:c,background:l}}function Cy(s){if(!s||typeof s!="object")return Ns;const e=s;return{boardSize:Number(e==null?void 0:e.boardSize)||Ns.boardSize,empty:(e==null?void 0:e.empty)??Ns.empty,placements:(e==null?void 0:e.placements)??Ns.placements}}async function Iy(){try{const s=await fetch(Ay);if(!s.ok)return Mu;const e=await s.json();return{board:Cy(e==null?void 0:e.board),render:Ry(e==null?void 0:e.render)}}catch{return Mu}}function Eu(s,e){if(e===hf)return console.warn("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles."),s;if(e===Vo||e===Qu){let t=s.getIndex();if(t===null){const a=[],o=s.getAttribute("position");if(o!==void 0){for(let l=0;l<o.count;l++)a.push(l);s.setIndex(a),t=s.getIndex()}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Undefined position attribute. Processing not possible."),s}const n=t.count-2,i=[];if(e===Vo)for(let a=1;a<=n;a++)i.push(t.getX(0)),i.push(t.getX(a)),i.push(t.getX(a+1));else for(let a=0;a<n;a++)a%2===0?(i.push(t.getX(a)),i.push(t.getX(a+1)),i.push(t.getX(a+2))):(i.push(t.getX(a+2)),i.push(t.getX(a+1)),i.push(t.getX(a)));i.length/3!==n&&console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles.");const r=s.clone();return r.setIndex(i),r.clearGroups(),r}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:",e),s}function Py(s){const e=new Map,t=new Map,n=s.clone();return hd(s,n,function(i,r){e.set(r,i),t.set(i,r)}),n.traverse(function(i){if(!i.isSkinnedMesh)return;const r=i,a=e.get(i),o=a.skeleton.bones;r.skeleton=a.skeleton.clone(),r.bindMatrix.copy(a.bindMatrix),r.skeleton.bones=o.map(function(l){return t.get(l)}),r.bind(r.skeleton,r.bindMatrix)}),n}function hd(s,e,t){t(s,e);for(let n=0;n<s.children.length;n++)hd(s.children[n],e.children[n],t)}class Dy extends gs{constructor(e){super(e),this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function(t){return new Oy(t)}),this.register(function(t){return new By(t)}),this.register(function(t){return new Yy(t)}),this.register(function(t){return new $y(t)}),this.register(function(t){return new Ky(t)}),this.register(function(t){return new zy(t)}),this.register(function(t){return new Vy(t)}),this.register(function(t){return new Gy(t)}),this.register(function(t){return new Hy(t)}),this.register(function(t){return new Fy(t)}),this.register(function(t){return new Wy(t)}),this.register(function(t){return new ky(t)}),this.register(function(t){return new qy(t)}),this.register(function(t){return new Xy(t)}),this.register(function(t){return new Ny(t)}),this.register(function(t){return new Tu(t,Xe.EXT_MESHOPT_COMPRESSION)}),this.register(function(t){return new Tu(t,Xe.KHR_MESHOPT_COMPRESSION)}),this.register(function(t){return new jy(t)})}load(e,t,n,i){const r=this;let a;if(this.resourcePath!=="")a=this.resourcePath;else if(this.path!==""){const c=Bs.extractUrlBase(e);a=Bs.resolveURL(c,this.path)}else a=Bs.extractUrlBase(e);this.manager.itemStart(e);const o=function(c){i?i(c):console.error(c),r.manager.itemError(e),r.manager.itemEnd(e)},l=new mh(this.manager);l.setPath(this.path),l.setResponseType("arraybuffer"),l.setRequestHeader(this.requestHeader),l.setWithCredentials(this.withCredentials),l.load(e,function(c){try{r.parse(c,a,function(u){t(u),r.manager.itemEnd(e)},o)}catch(u){o(u)}},n,o)}setDRACOLoader(e){return this.dracoLoader=e,this}setKTX2Loader(e){return this.ktx2Loader=e,this}setMeshoptDecoder(e){return this.meshoptDecoder=e,this}register(e){return this.pluginCallbacks.indexOf(e)===-1&&this.pluginCallbacks.push(e),this}unregister(e){return this.pluginCallbacks.indexOf(e)!==-1&&this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(e),1),this}parse(e,t,n,i){let r;const a={},o={},l=new TextDecoder;if(typeof e=="string")r=JSON.parse(e);else if(e instanceof ArrayBuffer)if(l.decode(new Uint8Array(e,0,4))===dd){try{a[Xe.KHR_BINARY_GLTF]=new Zy(e)}catch(d){i&&i(d);return}r=JSON.parse(a[Xe.KHR_BINARY_GLTF].content)}else r=JSON.parse(l.decode(e));else r=e;if(r.asset===void 0||r.asset.version[0]<2){i&&i(new Error("THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported."));return}const c=new uM(r,{path:t||this.resourcePath||"",crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});c.fileLoader.setRequestHeader(this.requestHeader);for(let u=0;u<this.pluginCallbacks.length;u++){const d=this.pluginCallbacks[u](c);d.name||console.error("THREE.GLTFLoader: Invalid plugin found: missing name"),o[d.name]=d,a[d.name]=!0}if(r.extensionsUsed)for(let u=0;u<r.extensionsUsed.length;++u){const d=r.extensionsUsed[u],h=r.extensionsRequired||[];switch(d){case Xe.KHR_MATERIALS_UNLIT:a[d]=new Uy;break;case Xe.KHR_DRACO_MESH_COMPRESSION:a[d]=new Jy(r,this.dracoLoader);break;case Xe.KHR_TEXTURE_TRANSFORM:a[d]=new Qy;break;case Xe.KHR_MESH_QUANTIZATION:a[d]=new eM;break;default:h.indexOf(d)>=0&&o[d]===void 0&&console.warn('THREE.GLTFLoader: Unknown extension "'+d+'".')}}c.setExtensions(a),c.setPlugins(o),c.parse(n,i)}parseAsync(e,t){const n=this;return new Promise(function(i,r){n.parse(e,t,i,r)})}}function Ly(){let s={};return{get:function(e){return s[e]},add:function(e,t){s[e]=t},remove:function(e){delete s[e]},removeAll:function(){s={}}}}function Mt(s,e,t){const n=s.json.materials[e];return n.extensions&&n.extensions[t]?n.extensions[t]:null}const Xe={KHR_BINARY_GLTF:"KHR_binary_glTF",KHR_DRACO_MESH_COMPRESSION:"KHR_draco_mesh_compression",KHR_LIGHTS_PUNCTUAL:"KHR_lights_punctual",KHR_MATERIALS_CLEARCOAT:"KHR_materials_clearcoat",KHR_MATERIALS_DISPERSION:"KHR_materials_dispersion",KHR_MATERIALS_IOR:"KHR_materials_ior",KHR_MATERIALS_SHEEN:"KHR_materials_sheen",KHR_MATERIALS_SPECULAR:"KHR_materials_specular",KHR_MATERIALS_TRANSMISSION:"KHR_materials_transmission",KHR_MATERIALS_IRIDESCENCE:"KHR_materials_iridescence",KHR_MATERIALS_ANISOTROPY:"KHR_materials_anisotropy",KHR_MATERIALS_UNLIT:"KHR_materials_unlit",KHR_MATERIALS_VOLUME:"KHR_materials_volume",KHR_TEXTURE_BASISU:"KHR_texture_basisu",KHR_TEXTURE_TRANSFORM:"KHR_texture_transform",KHR_MESH_QUANTIZATION:"KHR_mesh_quantization",KHR_MATERIALS_EMISSIVE_STRENGTH:"KHR_materials_emissive_strength",EXT_MATERIALS_BUMP:"EXT_materials_bump",EXT_TEXTURE_WEBP:"EXT_texture_webp",EXT_TEXTURE_AVIF:"EXT_texture_avif",EXT_MESHOPT_COMPRESSION:"EXT_meshopt_compression",KHR_MESHOPT_COMPRESSION:"KHR_meshopt_compression",EXT_MESH_GPU_INSTANCING:"EXT_mesh_gpu_instancing"};class Ny{constructor(e){this.parser=e,this.name=Xe.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){const e=this.parser,t=this.parser.json.nodes||[];for(let n=0,i=t.length;n<i;n++){const r=t[n];r.extensions&&r.extensions[this.name]&&r.extensions[this.name].light!==void 0&&e._addNodeRef(this.cache,r.extensions[this.name].light)}}_loadLight(e){const t=this.parser,n="light:"+e;let i=t.cache.get(n);if(i)return i;const r=t.json,l=((r.extensions&&r.extensions[this.name]||{}).lights||[])[e];let c;const u=new Ne(16777215);l.color!==void 0&&u.setRGB(l.color[0],l.color[1],l.color[2],zt);const d=l.range!==void 0?l.range:0;switch(l.type){case"directional":c=new vh(u),c.target.position.set(0,0,-1),c.add(c.target);break;case"point":c=new zp(u),c.distance=d;break;case"spot":c=new Bp(u),c.distance=d,l.spot=l.spot||{},l.spot.innerConeAngle=l.spot.innerConeAngle!==void 0?l.spot.innerConeAngle:0,l.spot.outerConeAngle=l.spot.outerConeAngle!==void 0?l.spot.outerConeAngle:Math.PI/4,c.angle=l.spot.outerConeAngle,c.penumbra=1-l.spot.innerConeAngle/l.spot.outerConeAngle,c.target.position.set(0,0,-1),c.add(c.target);break;default:throw new Error("THREE.GLTFLoader: Unexpected light type: "+l.type)}return c.position.set(0,0,0),yn(c,l),l.intensity!==void 0&&(c.intensity=l.intensity),c.name=t.createUniqueName(l.name||"light_"+e),i=Promise.resolve(c),t.cache.add(n,i),i}getDependency(e,t){if(e==="light")return this._loadLight(t)}createNodeAttachment(e){const t=this,n=this.parser,r=n.json.nodes[e],o=(r.extensions&&r.extensions[this.name]||{}).light;return o===void 0?null:this._loadLight(o).then(function(l){return n._getNodeRef(t.cache,o,l)})}}class Uy{constructor(){this.name=Xe.KHR_MATERIALS_UNLIT}getMaterialType(){return ti}extendParams(e,t,n){const i=[];e.color=new Ne(1,1,1),e.opacity=1;const r=t.pbrMetallicRoughness;if(r){if(Array.isArray(r.baseColorFactor)){const a=r.baseColorFactor;e.color.setRGB(a[0],a[1],a[2],zt),e.opacity=a[3]}r.baseColorTexture!==void 0&&i.push(n.assignTexture(e,"map",r.baseColorTexture,Dt))}return Promise.all(i)}}class Fy{constructor(e){this.parser=e,this.name=Xe.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(e,t){const n=Mt(this.parser,e,this.name);return n===null||n.emissiveStrength!==void 0&&(t.emissiveIntensity=n.emissiveStrength),Promise.resolve()}}class Oy{constructor(e){this.parser=e,this.name=Xe.KHR_MATERIALS_CLEARCOAT}getMaterialType(e){return Mt(this.parser,e,this.name)!==null?In:null}extendMaterialParams(e,t){const n=Mt(this.parser,e,this.name);if(n===null)return Promise.resolve();const i=[];if(n.clearcoatFactor!==void 0&&(t.clearcoat=n.clearcoatFactor),n.clearcoatTexture!==void 0&&i.push(this.parser.assignTexture(t,"clearcoatMap",n.clearcoatTexture)),n.clearcoatRoughnessFactor!==void 0&&(t.clearcoatRoughness=n.clearcoatRoughnessFactor),n.clearcoatRoughnessTexture!==void 0&&i.push(this.parser.assignTexture(t,"clearcoatRoughnessMap",n.clearcoatRoughnessTexture)),n.clearcoatNormalTexture!==void 0&&(i.push(this.parser.assignTexture(t,"clearcoatNormalMap",n.clearcoatNormalTexture)),n.clearcoatNormalTexture.scale!==void 0)){const r=n.clearcoatNormalTexture.scale;t.clearcoatNormalScale=new Be(r,r)}return Promise.all(i)}}class By{constructor(e){this.parser=e,this.name=Xe.KHR_MATERIALS_DISPERSION}getMaterialType(e){return Mt(this.parser,e,this.name)!==null?In:null}extendMaterialParams(e,t){const n=Mt(this.parser,e,this.name);return n===null||(t.dispersion=n.dispersion!==void 0?n.dispersion:0),Promise.resolve()}}class ky{constructor(e){this.parser=e,this.name=Xe.KHR_MATERIALS_IRIDESCENCE}getMaterialType(e){return Mt(this.parser,e,this.name)!==null?In:null}extendMaterialParams(e,t){const n=Mt(this.parser,e,this.name);if(n===null)return Promise.resolve();const i=[];return n.iridescenceFactor!==void 0&&(t.iridescence=n.iridescenceFactor),n.iridescenceTexture!==void 0&&i.push(this.parser.assignTexture(t,"iridescenceMap",n.iridescenceTexture)),n.iridescenceIor!==void 0&&(t.iridescenceIOR=n.iridescenceIor),t.iridescenceThicknessRange===void 0&&(t.iridescenceThicknessRange=[100,400]),n.iridescenceThicknessMinimum!==void 0&&(t.iridescenceThicknessRange[0]=n.iridescenceThicknessMinimum),n.iridescenceThicknessMaximum!==void 0&&(t.iridescenceThicknessRange[1]=n.iridescenceThicknessMaximum),n.iridescenceThicknessTexture!==void 0&&i.push(this.parser.assignTexture(t,"iridescenceThicknessMap",n.iridescenceThicknessTexture)),Promise.all(i)}}class zy{constructor(e){this.parser=e,this.name=Xe.KHR_MATERIALS_SHEEN}getMaterialType(e){return Mt(this.parser,e,this.name)!==null?In:null}extendMaterialParams(e,t){const n=Mt(this.parser,e,this.name);if(n===null)return Promise.resolve();const i=[];if(t.sheenColor=new Ne(0,0,0),t.sheenRoughness=0,t.sheen=1,n.sheenColorFactor!==void 0){const r=n.sheenColorFactor;t.sheenColor.setRGB(r[0],r[1],r[2],zt)}return n.sheenRoughnessFactor!==void 0&&(t.sheenRoughness=n.sheenRoughnessFactor),n.sheenColorTexture!==void 0&&i.push(this.parser.assignTexture(t,"sheenColorMap",n.sheenColorTexture,Dt)),n.sheenRoughnessTexture!==void 0&&i.push(this.parser.assignTexture(t,"sheenRoughnessMap",n.sheenRoughnessTexture)),Promise.all(i)}}class Vy{constructor(e){this.parser=e,this.name=Xe.KHR_MATERIALS_TRANSMISSION}getMaterialType(e){return Mt(this.parser,e,this.name)!==null?In:null}extendMaterialParams(e,t){const n=Mt(this.parser,e,this.name);if(n===null)return Promise.resolve();const i=[];return n.transmissionFactor!==void 0&&(t.transmission=n.transmissionFactor),n.transmissionTexture!==void 0&&i.push(this.parser.assignTexture(t,"transmissionMap",n.transmissionTexture)),Promise.all(i)}}class Gy{constructor(e){this.parser=e,this.name=Xe.KHR_MATERIALS_VOLUME}getMaterialType(e){return Mt(this.parser,e,this.name)!==null?In:null}extendMaterialParams(e,t){const n=Mt(this.parser,e,this.name);if(n===null)return Promise.resolve();const i=[];t.thickness=n.thicknessFactor!==void 0?n.thicknessFactor:0,n.thicknessTexture!==void 0&&i.push(this.parser.assignTexture(t,"thicknessMap",n.thicknessTexture)),t.attenuationDistance=n.attenuationDistance||1/0;const r=n.attenuationColor||[1,1,1];return t.attenuationColor=new Ne().setRGB(r[0],r[1],r[2],zt),Promise.all(i)}}class Hy{constructor(e){this.parser=e,this.name=Xe.KHR_MATERIALS_IOR}getMaterialType(e){return Mt(this.parser,e,this.name)!==null?In:null}extendMaterialParams(e,t){const n=Mt(this.parser,e,this.name);return n===null||(t.ior=n.ior!==void 0?n.ior:1.5),Promise.resolve()}}class Wy{constructor(e){this.parser=e,this.name=Xe.KHR_MATERIALS_SPECULAR}getMaterialType(e){return Mt(this.parser,e,this.name)!==null?In:null}extendMaterialParams(e,t){const n=Mt(this.parser,e,this.name);if(n===null)return Promise.resolve();const i=[];t.specularIntensity=n.specularFactor!==void 0?n.specularFactor:1,n.specularTexture!==void 0&&i.push(this.parser.assignTexture(t,"specularIntensityMap",n.specularTexture));const r=n.specularColorFactor||[1,1,1];return t.specularColor=new Ne().setRGB(r[0],r[1],r[2],zt),n.specularColorTexture!==void 0&&i.push(this.parser.assignTexture(t,"specularColorMap",n.specularColorTexture,Dt)),Promise.all(i)}}class Xy{constructor(e){this.parser=e,this.name=Xe.EXT_MATERIALS_BUMP}getMaterialType(e){return Mt(this.parser,e,this.name)!==null?In:null}extendMaterialParams(e,t){const n=Mt(this.parser,e,this.name);if(n===null)return Promise.resolve();const i=[];return t.bumpScale=n.bumpFactor!==void 0?n.bumpFactor:1,n.bumpTexture!==void 0&&i.push(this.parser.assignTexture(t,"bumpMap",n.bumpTexture)),Promise.all(i)}}class qy{constructor(e){this.parser=e,this.name=Xe.KHR_MATERIALS_ANISOTROPY}getMaterialType(e){return Mt(this.parser,e,this.name)!==null?In:null}extendMaterialParams(e,t){const n=Mt(this.parser,e,this.name);if(n===null)return Promise.resolve();const i=[];return n.anisotropyStrength!==void 0&&(t.anisotropy=n.anisotropyStrength),n.anisotropyRotation!==void 0&&(t.anisotropyRotation=n.anisotropyRotation),n.anisotropyTexture!==void 0&&i.push(this.parser.assignTexture(t,"anisotropyMap",n.anisotropyTexture)),Promise.all(i)}}class Yy{constructor(e){this.parser=e,this.name=Xe.KHR_TEXTURE_BASISU}loadTexture(e){const t=this.parser,n=t.json,i=n.textures[e];if(!i.extensions||!i.extensions[this.name])return null;const r=i.extensions[this.name],a=t.options.ktx2Loader;if(!a){if(n.extensionsRequired&&n.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures");return null}return t.loadTextureImage(e,r.source,a)}}class $y{constructor(e){this.parser=e,this.name=Xe.EXT_TEXTURE_WEBP}loadTexture(e){const t=this.name,n=this.parser,i=n.json,r=i.textures[e];if(!r.extensions||!r.extensions[t])return null;const a=r.extensions[t],o=i.images[a.source];let l=n.textureLoader;if(o.uri){const c=n.options.manager.getHandler(o.uri);c!==null&&(l=c)}return n.loadTextureImage(e,a.source,l)}}class Ky{constructor(e){this.parser=e,this.name=Xe.EXT_TEXTURE_AVIF}loadTexture(e){const t=this.name,n=this.parser,i=n.json,r=i.textures[e];if(!r.extensions||!r.extensions[t])return null;const a=r.extensions[t],o=i.images[a.source];let l=n.textureLoader;if(o.uri){const c=n.options.manager.getHandler(o.uri);c!==null&&(l=c)}return n.loadTextureImage(e,a.source,l)}}class Tu{constructor(e,t){this.name=t,this.parser=e}loadBufferView(e){const t=this.parser.json,n=t.bufferViews[e];if(n.extensions&&n.extensions[this.name]){const i=n.extensions[this.name],r=this.parser.getDependency("buffer",i.buffer),a=this.parser.options.meshoptDecoder;if(!a||!a.supported){if(t.extensionsRequired&&t.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files");return null}return r.then(function(o){const l=i.byteOffset||0,c=i.byteLength||0,u=i.count,d=i.byteStride,h=new Uint8Array(o,l,c);return a.decodeGltfBufferAsync?a.decodeGltfBufferAsync(u,d,h,i.mode,i.filter).then(function(f){return f.buffer}):a.ready.then(function(){const f=new ArrayBuffer(u*d);return a.decodeGltfBuffer(new Uint8Array(f),u,d,h,i.mode,i.filter),f})})}else return null}}class jy{constructor(e){this.name=Xe.EXT_MESH_GPU_INSTANCING,this.parser=e}createNodeMesh(e){const t=this.parser.json,n=t.nodes[e];if(!n.extensions||!n.extensions[this.name]||n.mesh===void 0)return null;const i=t.meshes[n.mesh];for(const c of i.primitives)if(c.mode!==tn.TRIANGLES&&c.mode!==tn.TRIANGLE_STRIP&&c.mode!==tn.TRIANGLE_FAN&&c.mode!==void 0)return null;const a=n.extensions[this.name].attributes,o=[],l={};for(const c in a)o.push(this.parser.getDependency("accessor",a[c]).then(u=>(l[c]=u,l[c])));return o.length<1?null:(o.push(this.parser.createNodeMesh(e)),Promise.all(o).then(c=>{const u=c.pop(),d=u.isGroup?u.children:[u],h=c[0].count,f=[];for(const g of d){const S=new ze,m=new L,p=new rn,v=new L(1,1,1),M=new dp(g.geometry,g.material,h);for(let E=0;E<h;E++)l.TRANSLATION&&m.fromBufferAttribute(l.TRANSLATION,E),l.ROTATION&&p.fromBufferAttribute(l.ROTATION,E),l.SCALE&&v.fromBufferAttribute(l.SCALE,E),M.setMatrixAt(E,S.compose(m,p,v));for(const E in l)if(E==="_COLOR_0"){const A=l[E];M.instanceColor=new Ho(A.array,A.itemSize,A.normalized)}else E!=="TRANSLATION"&&E!=="ROTATION"&&E!=="SCALE"&&g.geometry.setAttribute(E,l[E]);gt.prototype.copy.call(M,g),this.parser.assignFinalMaterial(M),f.push(M)}return u.isGroup?(u.clear(),u.add(...f),u):f[0]}))}}const dd="glTF",Cs=12,bu={JSON:1313821514,BIN:5130562};class Zy{constructor(e){this.name=Xe.KHR_BINARY_GLTF,this.content=null,this.body=null;const t=new DataView(e,0,Cs),n=new TextDecoder;if(this.header={magic:n.decode(new Uint8Array(e.slice(0,4))),version:t.getUint32(4,!0),length:t.getUint32(8,!0)},this.header.magic!==dd)throw new Error("THREE.GLTFLoader: Unsupported glTF-Binary header.");if(this.header.version<2)throw new Error("THREE.GLTFLoader: Legacy binary file detected.");const i=this.header.length-Cs,r=new DataView(e,Cs);let a=0;for(;a<i;){const o=r.getUint32(a,!0);a+=4;const l=r.getUint32(a,!0);if(a+=4,l===bu.JSON){const c=new Uint8Array(e,Cs+a,o);this.content=n.decode(c)}else if(l===bu.BIN){const c=Cs+a;this.body=e.slice(c,c+o)}a+=o}if(this.content===null)throw new Error("THREE.GLTFLoader: JSON content not found.")}}class Jy{constructor(e,t){if(!t)throw new Error("THREE.GLTFLoader: No DRACOLoader instance provided.");this.name=Xe.KHR_DRACO_MESH_COMPRESSION,this.json=e,this.dracoLoader=t,this.dracoLoader.preload()}decodePrimitive(e,t){const n=this.json,i=this.dracoLoader,r=e.extensions[this.name].bufferView,a=e.extensions[this.name].attributes,o={},l={},c={};for(const u in a){const d=Zo[u]||u.toLowerCase();o[d]=a[u]}for(const u in e.attributes){const d=Zo[u]||u.toLowerCase();if(a[u]!==void 0){const h=n.accessors[e.attributes[u]],f=Qi[h.componentType];c[d]=f.name,l[d]=h.normalized===!0}}return t.getDependency("bufferView",r).then(function(u){return new Promise(function(d,h){i.decodeDracoFile(u,function(f){for(const g in f.attributes){const S=f.attributes[g],m=l[g];m!==void 0&&(S.normalized=m)}d(f)},o,c,zt,h)})})}}class Qy{constructor(){this.name=Xe.KHR_TEXTURE_TRANSFORM}extendTexture(e,t){return(t.texCoord===void 0||t.texCoord===e.channel)&&t.offset===void 0&&t.rotation===void 0&&t.scale===void 0||(e=e.clone(),t.texCoord!==void 0&&(e.channel=t.texCoord),t.offset!==void 0&&e.offset.fromArray(t.offset),t.rotation!==void 0&&(e.rotation=t.rotation),t.scale!==void 0&&e.repeat.fromArray(t.scale),e.needsUpdate=!0),e}}class eM{constructor(){this.name=Xe.KHR_MESH_QUANTIZATION}}class fd extends fs{constructor(e,t,n,i){super(e,t,n,i)}copySampleValue_(e){const t=this.resultBuffer,n=this.sampleValues,i=this.valueSize,r=e*i*3+i;for(let a=0;a!==i;a++)t[a]=n[r+a];return t}interpolate_(e,t,n,i){const r=this.resultBuffer,a=this.sampleValues,o=this.valueSize,l=o*2,c=o*3,u=i-t,d=(n-t)/u,h=d*d,f=h*d,g=e*c,S=g-c,m=-2*f+3*h,p=f-h,v=1-m,M=p-h+d;for(let E=0;E!==o;E++){const A=a[S+E+o],w=a[S+E+l]*u,C=a[g+E+o],x=a[g+E]*u;r[E]=v*A+M*w+m*C+p*x}return r}}const tM=new rn;class nM extends fd{interpolate_(e,t,n,i){const r=super.interpolate_(e,t,n,i);return tM.fromArray(r).normalize().toArray(r),r}}const tn={POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6},Qi={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},Au={9728:rt,9729:St,9984:qu,9985:Lr,9986:Ds,9987:zn},wu={33071:nn,33648:Gr,10497:is},Ya={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},Zo={POSITION:"position",NORMAL:"normal",TANGENT:"tangent",TEXCOORD_0:"uv",TEXCOORD_1:"uv1",TEXCOORD_2:"uv2",TEXCOORD_3:"uv3",COLOR_0:"color",WEIGHTS_0:"skinWeight",JOINTS_0:"skinIndex"},Qn={scale:"scale",translation:"position",rotation:"quaternion",weights:"morphTargetInfluences"},iM={CUBICSPLINE:void 0,LINEAR:Hs,STEP:Gs},$a={OPAQUE:"OPAQUE",MASK:"MASK",BLEND:"BLEND"};function sM(s){return s.DefaultMaterial===void 0&&(s.DefaultMaterial=new Ys({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:an})),s.DefaultMaterial}function fi(s,e,t){for(const n in t.extensions)s[n]===void 0&&(e.userData.gltfExtensions=e.userData.gltfExtensions||{},e.userData.gltfExtensions[n]=t.extensions[n])}function yn(s,e){e.extras!==void 0&&(typeof e.extras=="object"?Object.assign(s.userData,e.extras):console.warn("THREE.GLTFLoader: Ignoring primitive type .extras, "+e.extras))}function rM(s,e,t){let n=!1,i=!1,r=!1;for(let c=0,u=e.length;c<u;c++){const d=e[c];if(d.POSITION!==void 0&&(n=!0),d.NORMAL!==void 0&&(i=!0),d.COLOR_0!==void 0&&(r=!0),n&&i&&r)break}if(!n&&!i&&!r)return Promise.resolve(s);const a=[],o=[],l=[];for(let c=0,u=e.length;c<u;c++){const d=e[c];if(n){const h=d.POSITION!==void 0?t.getDependency("accessor",d.POSITION):s.attributes.position;a.push(h)}if(i){const h=d.NORMAL!==void 0?t.getDependency("accessor",d.NORMAL):s.attributes.normal;o.push(h)}if(r){const h=d.COLOR_0!==void 0?t.getDependency("accessor",d.COLOR_0):s.attributes.color;l.push(h)}}return Promise.all([Promise.all(a),Promise.all(o),Promise.all(l)]).then(function(c){const u=c[0],d=c[1],h=c[2];return n&&(s.morphAttributes.position=u),i&&(s.morphAttributes.normal=d),r&&(s.morphAttributes.color=h),s.morphTargetsRelative=!0,s})}function aM(s,e){if(s.updateMorphTargets(),e.weights!==void 0)for(let t=0,n=e.weights.length;t<n;t++)s.morphTargetInfluences[t]=e.weights[t];if(e.extras&&Array.isArray(e.extras.targetNames)){const t=e.extras.targetNames;if(s.morphTargetInfluences.length===t.length){s.morphTargetDictionary={};for(let n=0,i=t.length;n<i;n++)s.morphTargetDictionary[t[n]]=n}else console.warn("THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.")}}function oM(s){let e;const t=s.extensions&&s.extensions[Xe.KHR_DRACO_MESH_COMPRESSION];if(t?e="draco:"+t.bufferView+":"+t.indices+":"+Ka(t.attributes):e=s.indices+":"+Ka(s.attributes)+":"+s.mode,s.targets!==void 0)for(let n=0,i=s.targets.length;n<i;n++)e+=":"+Ka(s.targets[n]);return e}function Ka(s){let e="";const t=Object.keys(s).sort();for(let n=0,i=t.length;n<i;n++)e+=t[n]+":"+s[t[n]]+";";return e}function Jo(s){switch(s){case Int8Array:return 1/127;case Uint8Array:return 1/255;case Int16Array:return 1/32767;case Uint16Array:return 1/65535;default:throw new Error("THREE.GLTFLoader: Unsupported normalized accessor component type.")}}function lM(s){return s.search(/\.jpe?g($|\?)/i)>0||s.search(/^data\:image\/jpeg/)===0?"image/jpeg":s.search(/\.webp($|\?)/i)>0||s.search(/^data\:image\/webp/)===0?"image/webp":s.search(/\.ktx2($|\?)/i)>0||s.search(/^data\:image\/ktx2/)===0?"image/ktx2":"image/png"}const cM=new ze;class uM{constructor(e={},t={}){this.json=e,this.extensions={},this.plugins={},this.options=t,this.cache=new Ly,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let n=!1,i=-1,r=!1,a=-1;if(typeof navigator<"u"&&typeof navigator.userAgent<"u"){const o=navigator.userAgent;n=/^((?!chrome|android).)*safari/i.test(o)===!0;const l=o.match(/Version\/(\d+)/);i=n&&l?parseInt(l[1],10):-1,r=o.indexOf("Firefox")>-1,a=r?o.match(/Firefox\/([0-9]+)\./)[1]:-1}typeof createImageBitmap>"u"||n&&i<17||r&&a<98?this.textureLoader=new gh(this.options.manager):this.textureLoader=new Hp(this.options.manager),this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new mh(this.options.manager),this.fileLoader.setResponseType("arraybuffer"),this.options.crossOrigin==="use-credentials"&&this.fileLoader.setWithCredentials(!0)}setExtensions(e){this.extensions=e}setPlugins(e){this.plugins=e}parse(e,t){const n=this,i=this.json,r=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(a){return a._markDefs&&a._markDefs()}),Promise.all(this._invokeAll(function(a){return a.beforeRoot&&a.beforeRoot()})).then(function(){return Promise.all([n.getDependencies("scene"),n.getDependencies("animation"),n.getDependencies("camera")])}).then(function(a){const o={scene:a[0][i.scene||0],scenes:a[0],animations:a[1],cameras:a[2],asset:i.asset,parser:n,userData:{}};return fi(r,o,i),yn(o,i),Promise.all(n._invokeAll(function(l){return l.afterRoot&&l.afterRoot(o)})).then(function(){for(const l of o.scenes)l.updateMatrixWorld();e(o)})}).catch(t)}_markDefs(){const e=this.json.nodes||[],t=this.json.skins||[],n=this.json.meshes||[];for(let i=0,r=t.length;i<r;i++){const a=t[i].joints;for(let o=0,l=a.length;o<l;o++)e[a[o]].isBone=!0}for(let i=0,r=e.length;i<r;i++){const a=e[i];a.mesh!==void 0&&(this._addNodeRef(this.meshCache,a.mesh),a.skin!==void 0&&(n[a.mesh].isSkinnedMesh=!0)),a.camera!==void 0&&this._addNodeRef(this.cameraCache,a.camera)}}_addNodeRef(e,t){t!==void 0&&(e.refs[t]===void 0&&(e.refs[t]=e.uses[t]=0),e.refs[t]++)}_getNodeRef(e,t,n){if(e.refs[t]<=1)return n;const i=n.clone(),r=(a,o)=>{const l=this.associations.get(a);l!=null&&this.associations.set(o,l);for(const[c,u]of a.children.entries())r(u,o.children[c])};return r(n,i),i.name+="_instance_"+e.uses[t]++,i}_invokeOne(e){const t=Object.values(this.plugins);t.push(this);for(let n=0;n<t.length;n++){const i=e(t[n]);if(i)return i}return null}_invokeAll(e){const t=Object.values(this.plugins);t.unshift(this);const n=[];for(let i=0;i<t.length;i++){const r=e(t[i]);r&&n.push(r)}return n}getDependency(e,t){const n=e+":"+t;let i=this.cache.get(n);if(!i){switch(e){case"scene":i=this.loadScene(t);break;case"node":i=this._invokeOne(function(r){return r.loadNode&&r.loadNode(t)});break;case"mesh":i=this._invokeOne(function(r){return r.loadMesh&&r.loadMesh(t)});break;case"accessor":i=this.loadAccessor(t);break;case"bufferView":i=this._invokeOne(function(r){return r.loadBufferView&&r.loadBufferView(t)});break;case"buffer":i=this.loadBuffer(t);break;case"material":i=this._invokeOne(function(r){return r.loadMaterial&&r.loadMaterial(t)});break;case"texture":i=this._invokeOne(function(r){return r.loadTexture&&r.loadTexture(t)});break;case"skin":i=this.loadSkin(t);break;case"animation":i=this._invokeOne(function(r){return r.loadAnimation&&r.loadAnimation(t)});break;case"camera":i=this.loadCamera(t);break;default:if(i=this._invokeOne(function(r){return r!=this&&r.getDependency&&r.getDependency(e,t)}),!i)throw new Error("Unknown type: "+e);break}this.cache.add(n,i)}return i}getDependencies(e){let t=this.cache.get(e);if(!t){const n=this,i=this.json[e+(e==="mesh"?"es":"s")]||[];t=Promise.all(i.map(function(r,a){return n.getDependency(e,a)})),this.cache.add(e,t)}return t}loadBuffer(e){const t=this.json.buffers[e],n=this.fileLoader;if(t.type&&t.type!=="arraybuffer")throw new Error("THREE.GLTFLoader: "+t.type+" buffer type is not supported.");if(t.uri===void 0&&e===0)return Promise.resolve(this.extensions[Xe.KHR_BINARY_GLTF].body);const i=this.options;return new Promise(function(r,a){n.load(Bs.resolveURL(t.uri,i.path),r,void 0,function(){a(new Error('THREE.GLTFLoader: Failed to load buffer "'+t.uri+'".'))})})}loadBufferView(e){const t=this.json.bufferViews[e];return this.getDependency("buffer",t.buffer).then(function(n){const i=t.byteLength||0,r=t.byteOffset||0;return n.slice(r,r+i)})}loadAccessor(e){const t=this,n=this.json,i=this.json.accessors[e];if(i.bufferView===void 0&&i.sparse===void 0){const a=Ya[i.type],o=Qi[i.componentType],l=i.normalized===!0,c=new o(i.count*a);return Promise.resolve(new kt(c,a,l))}const r=[];return i.bufferView!==void 0?r.push(this.getDependency("bufferView",i.bufferView)):r.push(null),i.sparse!==void 0&&(r.push(this.getDependency("bufferView",i.sparse.indices.bufferView)),r.push(this.getDependency("bufferView",i.sparse.values.bufferView))),Promise.all(r).then(function(a){const o=a[0],l=Ya[i.type],c=Qi[i.componentType],u=c.BYTES_PER_ELEMENT,d=u*l,h=i.byteOffset||0,f=i.bufferView!==void 0?n.bufferViews[i.bufferView].byteStride:void 0,g=i.normalized===!0;let S,m;if(f&&f!==d){const p=Math.floor(h/f),v="InterleavedBuffer:"+i.bufferView+":"+i.componentType+":"+p+":"+i.count;let M=t.cache.get(v);M||(S=new c(o,p*f,i.count*f/u),M=new rp(S,f/u),t.cache.add(v,M)),m=new Sl(M,l,h%f/u,g)}else o===null?S=new c(i.count*l):S=new c(o,h,i.count*l),m=new kt(S,l,g);if(i.sparse!==void 0){const p=Ya.SCALAR,v=Qi[i.sparse.indices.componentType],M=i.sparse.indices.byteOffset||0,E=i.sparse.values.byteOffset||0,A=new v(a[1],M,i.sparse.count*p),w=new c(a[2],E,i.sparse.count*l);o!==null&&(m=new kt(m.array.slice(),m.itemSize,m.normalized)),m.normalized=!1;for(let C=0,x=A.length;C<x;C++){const T=A[C];if(m.setX(T,w[C*l]),l>=2&&m.setY(T,w[C*l+1]),l>=3&&m.setZ(T,w[C*l+2]),l>=4&&m.setW(T,w[C*l+3]),l>=5)throw new Error("THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.")}m.normalized=g}return m})}loadTexture(e){const t=this.json,n=this.options,r=t.textures[e].source,a=t.images[r];let o=this.textureLoader;if(a.uri){const l=n.manager.getHandler(a.uri);l!==null&&(o=l)}return this.loadTextureImage(e,r,o)}loadTextureImage(e,t,n){const i=this,r=this.json,a=r.textures[e],o=r.images[t],l=(o.uri||o.bufferView)+":"+a.sampler;if(this.textureCache[l])return this.textureCache[l];const c=this.loadImageSource(t,n).then(function(u){u.flipY=!1,u.name=a.name||o.name||"",u.name===""&&typeof o.uri=="string"&&o.uri.startsWith("data:image/")===!1&&(u.name=o.uri);const h=(r.samplers||{})[a.sampler]||{};return u.magFilter=Au[h.magFilter]||St,u.minFilter=Au[h.minFilter]||zn,u.wrapS=wu[h.wrapS]||is,u.wrapT=wu[h.wrapT]||is,u.generateMipmaps=!u.isCompressedTexture&&u.minFilter!==rt&&u.minFilter!==St,i.associations.set(u,{textures:e}),u}).catch(function(){return null});return this.textureCache[l]=c,c}loadImageSource(e,t){const n=this,i=this.json,r=this.options;if(this.sourceCache[e]!==void 0)return this.sourceCache[e].then(d=>d.clone());const a=i.images[e],o=self.URL||self.webkitURL;let l=a.uri||"",c=!1;if(a.bufferView!==void 0)l=n.getDependency("bufferView",a.bufferView).then(function(d){c=!0;const h=new Blob([d],{type:a.mimeType});return l=o.createObjectURL(h),l});else if(a.uri===void 0)throw new Error("THREE.GLTFLoader: Image "+e+" is missing URI and bufferView");const u=Promise.resolve(l).then(function(d){return new Promise(function(h,f){let g=h;t.isImageBitmapLoader===!0&&(g=function(S){const m=new It(S);m.needsUpdate=!0,h(m)}),t.load(Bs.resolveURL(d,r.path),g,void 0,f)})}).then(function(d){return c===!0&&o.revokeObjectURL(l),yn(d,a),d.userData.mimeType=a.mimeType||lM(a.uri),d}).catch(function(d){throw console.error("THREE.GLTFLoader: Couldn't load texture",l),d});return this.sourceCache[e]=u,u}assignTexture(e,t,n,i){const r=this;return this.getDependency("texture",n.index).then(function(a){if(!a)return null;if(n.texCoord!==void 0&&n.texCoord>0&&(a=a.clone(),a.channel=n.texCoord),r.extensions[Xe.KHR_TEXTURE_TRANSFORM]){const o=n.extensions!==void 0?n.extensions[Xe.KHR_TEXTURE_TRANSFORM]:void 0;if(o){const l=r.associations.get(a);a=r.extensions[Xe.KHR_TEXTURE_TRANSFORM].extendTexture(a,o),r.associations.set(a,l)}}return i!==void 0&&(a.colorSpace=i),e[t]=a,a})}assignFinalMaterial(e){const t=e.geometry;let n=e.material;const i=t.attributes.tangent===void 0,r=t.attributes.color!==void 0,a=t.attributes.normal===void 0;if(e.isPoints){const o="PointsMaterial:"+n.uuid;let l=this.cache.get(o);l||(l=new oh,mn.prototype.copy.call(l,n),l.color.copy(n.color),l.map=n.map,l.sizeAttenuation=!1,this.cache.add(o,l)),n=l}else if(e.isLine){const o="LineBasicMaterial:"+n.uuid;let l=this.cache.get(o);l||(l=new ah,mn.prototype.copy.call(l,n),l.color.copy(n.color),l.map=n.map,this.cache.add(o,l)),n=l}if(i||r||a){let o="ClonedMaterial:"+n.uuid+":";i&&(o+="derivative-tangents:"),r&&(o+="vertex-colors:"),a&&(o+="flat-shading:");let l=this.cache.get(o);l||(l=n.clone(),r&&(l.vertexColors=!0),a&&(l.flatShading=!0),i&&(l.normalScale&&(l.normalScale.y*=-1),l.clearcoatNormalScale&&(l.clearcoatNormalScale.y*=-1)),this.cache.add(o,l),this.associations.set(l,this.associations.get(n))),n=l}e.material=n}getMaterialType(){return Ys}loadMaterial(e){const t=this,n=this.json,i=this.extensions,r=n.materials[e];let a;const o={},l=r.extensions||{},c=[];if(l[Xe.KHR_MATERIALS_UNLIT]){const d=i[Xe.KHR_MATERIALS_UNLIT];a=d.getMaterialType(),c.push(d.extendParams(o,r,t))}else{const d=r.pbrMetallicRoughness||{};if(o.color=new Ne(1,1,1),o.opacity=1,Array.isArray(d.baseColorFactor)){const h=d.baseColorFactor;o.color.setRGB(h[0],h[1],h[2],zt),o.opacity=h[3]}d.baseColorTexture!==void 0&&c.push(t.assignTexture(o,"map",d.baseColorTexture,Dt)),o.metalness=d.metallicFactor!==void 0?d.metallicFactor:1,o.roughness=d.roughnessFactor!==void 0?d.roughnessFactor:1,d.metallicRoughnessTexture!==void 0&&(c.push(t.assignTexture(o,"metalnessMap",d.metallicRoughnessTexture)),c.push(t.assignTexture(o,"roughnessMap",d.metallicRoughnessTexture))),a=this._invokeOne(function(h){return h.getMaterialType&&h.getMaterialType(e)}),c.push(Promise.all(this._invokeAll(function(h){return h.extendMaterialParams&&h.extendMaterialParams(e,o)})))}r.doubleSided===!0&&(o.side=Zt);const u=r.alphaMode||$a.OPAQUE;if(u===$a.BLEND?(o.transparent=!0,o.depthWrite=!1):(o.transparent=!1,u===$a.MASK&&(o.alphaTest=r.alphaCutoff!==void 0?r.alphaCutoff:.5)),r.normalTexture!==void 0&&a!==ti&&(c.push(t.assignTexture(o,"normalMap",r.normalTexture)),o.normalScale=new Be(1,1),r.normalTexture.scale!==void 0)){const d=r.normalTexture.scale;o.normalScale.set(d,d)}if(r.occlusionTexture!==void 0&&a!==ti&&(c.push(t.assignTexture(o,"aoMap",r.occlusionTexture)),r.occlusionTexture.strength!==void 0&&(o.aoMapIntensity=r.occlusionTexture.strength)),r.emissiveFactor!==void 0&&a!==ti){const d=r.emissiveFactor;o.emissive=new Ne().setRGB(d[0],d[1],d[2],zt)}return r.emissiveTexture!==void 0&&a!==ti&&c.push(t.assignTexture(o,"emissiveMap",r.emissiveTexture,Dt)),Promise.all(c).then(function(){const d=new a(o);return r.name&&(d.name=r.name),yn(d,r),t.associations.set(d,{materials:e}),r.extensions&&fi(i,d,r),d})}createUniqueName(e){const t=nt.sanitizeNodeName(e||"");return t in this.nodeNamesUsed?t+"_"+ ++this.nodeNamesUsed[t]:(this.nodeNamesUsed[t]=0,t)}loadGeometries(e){const t=this,n=this.extensions,i=this.primitiveCache;function r(o){return n[Xe.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(o,t).then(function(l){return Ru(l,o,t)})}const a=[];for(let o=0,l=e.length;o<l;o++){const c=e[o],u=oM(c),d=i[u];if(d)a.push(d.promise);else{let h;c.extensions&&c.extensions[Xe.KHR_DRACO_MESH_COMPRESSION]?h=r(c):h=Ru(new Vt,c,t),i[u]={primitive:c,promise:h},a.push(h)}}return Promise.all(a)}loadMesh(e){const t=this,n=this.json,i=this.extensions,r=n.meshes[e],a=r.primitives,o=[];for(let l=0,c=a.length;l<c;l++){const u=a[l].material===void 0?sM(this.cache):this.getDependency("material",a[l].material);o.push(u)}return o.push(t.loadGeometries(a)),Promise.all(o).then(function(l){const c=l.slice(0,l.length-1),u=l[l.length-1],d=[];for(let f=0,g=u.length;f<g;f++){const S=u[f],m=a[f];let p;const v=c[f];if(m.mode===tn.TRIANGLES||m.mode===tn.TRIANGLE_STRIP||m.mode===tn.TRIANGLE_FAN||m.mode===void 0)p=r.isSkinnedMesh===!0?new cp(S,v):new vt(S,v),p.isSkinnedMesh===!0&&p.normalizeSkinWeights(),m.mode===tn.TRIANGLE_STRIP?p.geometry=Eu(p.geometry,Qu):m.mode===tn.TRIANGLE_FAN&&(p.geometry=Eu(p.geometry,Vo));else if(m.mode===tn.LINES)p=new gp(S,v);else if(m.mode===tn.LINE_STRIP)p=new Tl(S,v);else if(m.mode===tn.LINE_LOOP)p=new _p(S,v);else if(m.mode===tn.POINTS)p=new vp(S,v);else throw new Error("THREE.GLTFLoader: Primitive mode unsupported: "+m.mode);Object.keys(p.geometry.morphAttributes).length>0&&aM(p,r),p.name=t.createUniqueName(r.name||"mesh_"+e),yn(p,r),m.extensions&&fi(i,p,m),t.assignFinalMaterial(p),d.push(p)}for(let f=0,g=d.length;f<g;f++)t.associations.set(d[f],{meshes:e,primitives:f});if(d.length===1)return r.extensions&&fi(i,d[0],r),d[0];const h=new Xt;r.extensions&&fi(i,h,r),t.associations.set(h,{meshes:e});for(let f=0,g=d.length;f<g;f++)h.add(d[f]);return h})}loadCamera(e){let t;const n=this.json.cameras[e],i=n[n.type];if(!i){console.warn("THREE.GLTFLoader: Missing camera parameters.");return}return n.type==="perspective"?t=new Gt(Vf.radToDeg(i.yfov),i.aspectRatio||1,i.znear||1,i.zfar||2e6):n.type==="orthographic"&&(t=new _s(-i.xmag,i.xmag,i.ymag,-i.ymag,i.znear,i.zfar)),n.name&&(t.name=this.createUniqueName(n.name)),yn(t,n),Promise.resolve(t)}loadSkin(e){const t=this.json.skins[e],n=[];for(let i=0,r=t.joints.length;i<r;i++)n.push(this._loadNodeShallow(t.joints[i]));return t.inverseBindMatrices!==void 0?n.push(this.getDependency("accessor",t.inverseBindMatrices)):n.push(null),Promise.all(n).then(function(i){const r=i.pop(),a=i,o=[],l=[];for(let c=0,u=a.length;c<u;c++){const d=a[c];if(d){o.push(d);const h=new ze;r!==null&&h.fromArray(r.array,c*16),l.push(h)}else console.warn('THREE.GLTFLoader: Joint "%s" could not be found.',t.joints[c])}return new Ml(o,l)})}loadAnimation(e){const t=this.json,n=this,i=t.animations[e],r=i.name?i.name:"animation_"+e,a=[],o=[],l=[],c=[],u=[];for(let d=0,h=i.channels.length;d<h;d++){const f=i.channels[d],g=i.samplers[f.sampler],S=f.target,m=S.node,p=i.parameters!==void 0?i.parameters[g.input]:g.input,v=i.parameters!==void 0?i.parameters[g.output]:g.output;S.node!==void 0&&(a.push(this.getDependency("node",m)),o.push(this.getDependency("accessor",p)),l.push(this.getDependency("accessor",v)),c.push(g),u.push(S))}return Promise.all([Promise.all(a),Promise.all(o),Promise.all(l),Promise.all(c),Promise.all(u)]).then(function(d){const h=d[0],f=d[1],g=d[2],S=d[3],m=d[4],p=[];for(let M=0,E=h.length;M<E;M++){const A=h[M],w=f[M],C=g[M],x=S[M],T=m[M];if(A===void 0)continue;A.updateMatrix&&A.updateMatrix();const H=n._createAnimationTracks(A,w,C,x,T);if(H)for(let R=0;R<H.length;R++)p.push(H[R])}const v=new Kr(r,void 0,p);return yn(v,i),v})}createNodeMesh(e){const t=this.json,n=this,i=t.nodes[e];return i.mesh===void 0?null:n.getDependency("mesh",i.mesh).then(function(r){const a=n._getNodeRef(n.meshCache,i.mesh,r);return i.weights!==void 0&&a.traverse(function(o){if(o.isMesh)for(let l=0,c=i.weights.length;l<c;l++)o.morphTargetInfluences[l]=i.weights[l]}),a})}loadNode(e){const t=this.json,n=this,i=t.nodes[e],r=n._loadNodeShallow(e),a=[],o=i.children||[];for(let c=0,u=o.length;c<u;c++)a.push(n.getDependency("node",o[c]));const l=i.skin===void 0?Promise.resolve(null):n.getDependency("skin",i.skin);return Promise.all([r,Promise.all(a),l]).then(function(c){const u=c[0],d=c[1],h=c[2];h!==null&&u.traverse(function(f){f.isSkinnedMesh&&f.bind(h,cM)});for(let f=0,g=d.length;f<g;f++)u.add(d[f]);if(u.userData.pivot!==void 0&&d.length>0){const f=u.userData.pivot,g=d[0];u.pivot=new L().fromArray(f),u.position.x-=f[0],u.position.y-=f[1],u.position.z-=f[2],g.position.set(0,0,0),delete u.userData.pivot}return u})}_loadNodeShallow(e){const t=this.json,n=this.extensions,i=this;if(this.nodeCache[e]!==void 0)return this.nodeCache[e];const r=t.nodes[e],a=r.name?i.createUniqueName(r.name):"",o=[],l=i._invokeOne(function(c){return c.createNodeMesh&&c.createNodeMesh(e)});return l&&o.push(l),r.camera!==void 0&&o.push(i.getDependency("camera",r.camera).then(function(c){return i._getNodeRef(i.cameraCache,r.camera,c)})),i._invokeAll(function(c){return c.createNodeAttachment&&c.createNodeAttachment(e)}).forEach(function(c){o.push(c)}),this.nodeCache[e]=Promise.all(o).then(function(c){let u;if(r.isBone===!0?u=new rh:c.length>1?u=new Xt:c.length===1?u=c[0]:u=new gt,u!==c[0])for(let d=0,h=c.length;d<h;d++)u.add(c[d]);if(r.name&&(u.userData.name=r.name,u.name=a),yn(u,r),r.extensions&&fi(n,u,r),r.matrix!==void 0){const d=new ze;d.fromArray(r.matrix),u.applyMatrix4(d)}else r.translation!==void 0&&u.position.fromArray(r.translation),r.rotation!==void 0&&u.quaternion.fromArray(r.rotation),r.scale!==void 0&&u.scale.fromArray(r.scale);if(!i.associations.has(u))i.associations.set(u,{});else if(r.mesh!==void 0&&i.meshCache.refs[r.mesh]>1){const d=i.associations.get(u);i.associations.set(u,{...d})}return i.associations.get(u).nodes=e,u}),this.nodeCache[e]}loadScene(e){const t=this.extensions,n=this.json.scenes[e],i=this,r=new Xt;n.name&&(r.name=i.createUniqueName(n.name)),yn(r,n),n.extensions&&fi(t,r,n);const a=n.nodes||[],o=[];for(let l=0,c=a.length;l<c;l++)o.push(i.getDependency("node",a[l]));return Promise.all(o).then(function(l){for(let u=0,d=l.length;u<d;u++){const h=l[u];h.parent!==null?r.add(Py(h)):r.add(h)}const c=u=>{const d=new Map;for(const[h,f]of i.associations)(h instanceof mn||h instanceof It)&&d.set(h,f);return u.traverse(h=>{const f=i.associations.get(h);f!=null&&d.set(h,f)}),d};return i.associations=c(r),r})}_createAnimationTracks(e,t,n,i,r){const a=[],o=e.name?e.name:e.uuid,l=[];Qn[r.path]===Qn.weights?e.traverse(function(h){h.morphTargetInfluences&&l.push(h.name?h.name:h.uuid)}):l.push(o);let c;switch(Qn[r.path]){case Qn.weights:c=ls;break;case Qn.rotation:c=cs;break;case Qn.translation:case Qn.scale:c=si;break;default:switch(n.itemSize){case 1:c=ls;break;case 2:case 3:default:c=si;break}break}const u=i.interpolation!==void 0?iM[i.interpolation]:Hs,d=this._getArrayFromAccessor(n);for(let h=0,f=l.length;h<f;h++){const g=new c(l[h]+"."+Qn[r.path],t.array,d,u);i.interpolation==="CUBICSPLINE"&&this._createCubicSplineTrackInterpolant(g),a.push(g)}return a}_getArrayFromAccessor(e){let t=e.array;if(e.normalized){const n=Jo(t.constructor),i=new Float32Array(t.length);for(let r=0,a=t.length;r<a;r++)i[r]=t[r]*n;t=i}return t}_createCubicSplineTrackInterpolant(e){e.createInterpolant=function(n){const i=this instanceof cs?nM:fd;return new i(this.times,this.values,this.getValueSize()/3,n)},e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}}function hM(s,e,t){const n=e.attributes,i=new Rn;if(n.POSITION!==void 0){const o=t.json.accessors[n.POSITION],l=o.min,c=o.max;if(l!==void 0&&c!==void 0){if(i.set(new L(l[0],l[1],l[2]),new L(c[0],c[1],c[2])),o.normalized){const u=Jo(Qi[o.componentType]);i.min.multiplyScalar(u),i.max.multiplyScalar(u)}}else{console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.");return}}else return;const r=e.targets;if(r!==void 0){const o=new L,l=new L;for(let c=0,u=r.length;c<u;c++){const d=r[c];if(d.POSITION!==void 0){const h=t.json.accessors[d.POSITION],f=h.min,g=h.max;if(f!==void 0&&g!==void 0){if(l.setX(Math.max(Math.abs(f[0]),Math.abs(g[0]))),l.setY(Math.max(Math.abs(f[1]),Math.abs(g[1]))),l.setZ(Math.max(Math.abs(f[2]),Math.abs(g[2]))),h.normalized){const S=Jo(Qi[h.componentType]);l.multiplyScalar(S)}o.max(l)}else console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.")}}i.expandByVector(o)}s.boundingBox=i;const a=new Cn;i.getCenter(a.center),a.radius=i.min.distanceTo(i.max)/2,s.boundingSphere=a}function Ru(s,e,t){const n=e.attributes,i=[];function r(a,o){return t.getDependency("accessor",a).then(function(l){s.setAttribute(o,l)})}for(const a in n){const o=Zo[a]||a.toLowerCase();o in s.attributes||i.push(r(n[a],o))}if(e.indices!==void 0&&!s.index){const a=t.getDependency("accessor",e.indices).then(function(o){s.setIndex(o)});i.push(a)}return $e.workingColorSpace!==zt&&"COLOR_0"in n&&console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${$e.workingColorSpace}" not supported.`),yn(s,e),hM(s,e,t),Promise.all(i).then(function(){return e.targets!==void 0?rM(s,e.targets,t):s})}function dM(s,e){return new Promise((t,n)=>{new Dy().load(s,i=>{const r=new Xt;r.add(i.scene),t(r)},i=>{if(!e)return;const r=typeof(i==null?void 0:i.loaded)=="number"?i.loaded:0,a=typeof(i==null?void 0:i.total)=="number"&&i.total>0?i.total:void 0;e({loaded:r,total:a})},n)})}const fM=`varying vec2 vUv;
...
`,mM=new L(4,10,4).normalize();function Cu(s){const e=s,t=e.map??null,n=e.color?e.color.clone():new Ne(16777215),i=e.opacity??1,r=e.transparent??i<1,a=e.side??an,o=e.alphaTest??0;return new yt({vertexShader:fM,fragmentShader:pM,uniforms:{map:{value:t},color:{value:n},lightDir:{value:mM.clone()},levels:{value:3},rimStrength:{value:.4},rimPower:{value:2},opacity:{value:i},crestStrength:{value:.01},crestWidth:{value:.01}},transparent:r,side:a,alphaTest:o,extensions:{derivatives:!0}})}function gM(s){const e=s.material;Array.isArray(e)?s.material=e.map(t=>Cu(t)):s.material=Cu(e)}function Iu(s){s.traverse(e=>{const t=e;t.isMesh&&gM(t)})}const _M=.5*1.5;function vM(s){const e=s.startsWith("/")?s:`/models/${s}.glb`;return us(e)}function xM(){const s=new Xt;return s.add(new vt(new bl(.15,.3,4,8),nS())),s}function Pu(s){s.rotation.y=Math.PI/4;const t=new Rn().setFromObject(s).getSize(new L),n=Math.max(t.x,t.y,t.z,.001)/1.5,i=_M/n;s.scale.setScalar(i)}function SM(){const e=ia().map(a=>[a.unitType,a.modelGlb]),t=Object.fromEntries(e),n=t.commander,i=t.archer,r=t.swordsman;if(!n||!i||!r)throw new Error("[loadUnitModels] отсутствует modelGlb в конфиге бойцов");return{commander:n,archer:i,swordsman:r}}async function yM(s){const e=SM(),t=async a=>{try{const o=await dM(vM(e[a]),l=>s==null?void 0:s({name:a,progress:l}));return Pu(o),Iu(o),o}catch(o){console.warn(`[loadUnitModels] не удалось загрузить модель для ${a}:`,o);const l=xM();return Pu(l),Iu(l),l}},[n,i,r]=await Promise.all([t("commander"),t("archer"),t("swordsman")]);return{commander:n,archer:i,swordsman:r}}const Yi=["commander","archer","swordsman"];function MM(s){return s<0?0:s>1?1:s}function EM(s){return Math.round(MM(s)*100)}function TM(s){if(Yi.every(n=>typeof s[n].total=="number"&&(s[n].total??0)>0)){const n=Yi.reduce((r,a)=>r+(s[a].total??0),0),i=Yi.reduce((r,a)=>r+Math.min(s[a].loaded??0,s[a].total??0),0);return n>0?i/n:0}return Yi.filter(n=>s[n].done).length/Yi.length}function bM(s){return s==="commander"?"Командир":s==="archer"?"Лучник":"Мечник"}async function AM(s){const n={commander:{done:!1},archer:{done:!1},swordsman:{done:!1}},i=l=>{const c=TM(n),u=.05*1+.95*c;s==null||s({percent:EM(u),detail:l})};s==null||s({percent:0,detail:"Загрузка конфига…"});const r=await Iy();i("Загрузка текстур…");const a=await new Promise((l,c)=>{new gh().load(us("/textures/arrow.png"),l,void 0,c)});a.wrapS=nn,a.wrapT=nn,a.flipY=!1,a.minFilter=rt,a.magFilter=rt,a.needsUpdate=!0,i("Загрузка моделей…");const o=await yM(l=>{const c=l.name;n[c].loaded=l.progress.loaded,n[c].total=l.progress.total,i(`Модель: ${bM(c)}…`)}).then(l=>{for(const c of Yi)n[c].done=!0;return i("Готово"),l});return s==null||s({percent:100,detail:"Готово"}),{appConfig:r,unitModels:o,arrowTexture:a}}const pd="gridlock_total_games_completed";function Ks(s,e){typeof window.gtag=="function"&&window.gtag("event",s,e)}function wM(s,e){typeof window.gtag=="function"&&window.gtag("set","user_properties",{[s]:e})}function RM(){if(typeof window>"u"||!window.localStorage)return 0;const s=window.localStorage.getItem(pd),e=s?parseInt(s,10):0;return Number.isNaN(e)?0:e}function CM(){const s=RM()+1;return typeof window<"u"&&window.localStorage&&window.localStorage.setItem(pd,String(s)),wM("total_games_completed",s),s}function IM(s){Ks("mode_select",{mode:s})}function PM(s,e){Ks("game_start",{mode:s,game_number_in_session:e})}function Du(s){Ks("player_move",{mode:s})}function Lu(s,e,t){Ks("game_over",{mode:s,result:e,game_number_in_session:t}),CM()}function DM(){Ks("play_again_click")}const md="fire",gd="Огонь",_d="/textures/commander_face.jpg",vd=200,LM={id:md,title:gd,avatarImg:_d,price:vd},NM=Object.freeze(Object.defineProperty({__proto__:null,avatarImg:_d,default:LM,id:md,price:vd,title:gd},Symbol.toStringTag,{value:"Module"})),xd="ice",Sd="Лед",yd="/textures/archer_face.jpg",Md=150,UM={id:xd,title:Sd,avatarImg:yd,price:Md},FM=Object.freeze(Object.defineProperty({__proto__:null,avatarImg:yd,default:UM,id:xd,price:Md,title:Sd},Symbol.toStringTag,{value:"Module"})),OM=Object.assign({"./configs/fire.json":NM,"./configs/ice.json":FM});function BM(s){return{...s,avatarImg:us(s.avatarImg)}}function Ed(){return Object.values(OM).map(s=>BM(s.default))}function kM(s){const t=Ed().find(n=>n.id===s);if(!t)throw new Error(`[skins] неизвестный skinId: ${s}`);return t}class zM{constructor(e){Le(this,"data");Le(this,"owned");Le(this,"disabled");this.data=e.data,this.owned=e.owned,this.disabled=e.disabled}render(){const e=this.data.kind==="skin"?"СКИН":"ЮНИТ",t=this.data.kind==="skin"?"badge-skin":"badge-unit";return`
    ...
    `}}const VM="lobby-container",GM=3,Vr=5,Nu=50,Uu=10,Fu={1:{name:"Трущобы",theme:"slate",desc:"Уличные банды",icon:"🏚"},2:{name:"Промзона",theme:"orange",desc:"Тяжёлые машины",icon:"🏭"},3:{name:"Центр",theme:"indigo",desc:"Корпораты",icon:"🏢"},4:{name:"Порт",theme:"cyan",desc:"Контрабандисты",icon:"⚓"},5:{name:"Мэрия",theme:"purple",desc:"Финальный босс",icon:"👑"}};function ks(s){var e;return{id:s.id,name:s.title,power:s.power,avatarImg:s.avatarImg,maxHealth:(e=s.unit)==null?void 0:e.maxHealth}}function HM(s){const e=jh().map(ks),t=s.ownedFighters.map(i=>ks(Si(i))),n=new Map;for(const i of[...e,...t])n.set(i.id,i);return Array.from(n.values())}function Ou(s){return["commander",...s.filter(t=>t!=="commander")]}function WM(s){const e=px().map(a=>({id:a.id,name:a.title,price:a.unlock.price,kind:"unit",avatarImg:a.avatarImg})),t=Ed().map(a=>({id:a.id,name:a.title,price:a.price,kind:"skin",avatarImg:a.avatarImg})),n=[...e,...t],i=a=>s.ownedFighters.includes(a)||s.ownedSkins.includes(a);return{items:n,disabled:a=>{const o=n.find(l=>l.id===a);return!o||i(a)||s.currency<o.price},owned:i}}function Td(s,e,t){return Math.max(e,Math.min(t,Math.floor(s)))}function Is(s){return Td(s,1,Vr)}function XM(s,e){var n;const t=e;return(n=t==null?void 0:t.closest)==null?void 0:n.call(t,"[data-action]")}function qM(s,e){var n;const t=e;return((n=t==null?void 0:t.closest)==null?void 0:n.call(t,"button[data-tab]"))??null}function YM(s){return Array.from({length:s}).map(()=>'<div style="width:5px;height:5px;background:var(--c-blue);border:1px solid rgba(255,255,255,0.3);display:inline-block;margin-right:2px;"></div>').join("")}class $M{constructor(e){Le(this,"container");Le(this,"state");Le(this,"teamSize");Le(this,"uiState","lobby");Le(this,"combatResult",null);Le(this,"listenersAttached",!1);Le(this,"onRequestStart");Le(this,"onPlayerStateChange");Le(this,"playerState");const t=(e==null?void 0:e.teamSize)??GM;this.container=document.createElement("div"),this.container.id=VM,this.container.className="lobby-root";const n=(e==null?void 0:e.playerState)??{currency:100,ownedFighters:[],ownedSkins:[],deck:[],gameMode:"pve"};this.playerState={...n,deck:Ou(n.deck)},this.state={activeTab:"home",currency:this.playerState.currency,currentLevel:1,selectedLevel:1,team:this.playerState.deck.map(i=>ks(Si(i))),inventory:HM(this.playerState),gameMode:this.playerState.gameMode},this.teamSize=Td(t,3,5),this.onRequestStart=(e==null?void 0:e.onRequestStart)??null,this.onPlayerStateChange=(e==null?void 0:e.onPlayerStateChange)??null}mount(e){e.appendChild(this.container),this.attachListenersOnce(),this.rerender()}unmount(){this.container.remove()}getElement(){return this.container}rerender(){this.container.innerHTML=this.renderRoot()}renderRoot(){return this.uiState==="results"?this.renderResults():`
    ...
    `}renderTab(e){return e==="home"?this.renderHomeTab():e==="team"?this.renderTeamTab():this.renderShopTab()}renderHomeTab(){const e=Is(this.state.selectedLevel),t=Is(this.state.currentLevel),n=Fu[e],i=[1,2,3,4,5].map(o=>{const l=o<=t,c=o===e;let u="map-level-node";return l&&(u+=" unlocked"),c&&(u+=" selected"),o===t&&(u+=" current"),`
        <div class="${u}" data-action="level-select" data-level="${o}">
          <div class="map-level-node__dot">${l?o:"?"}</div>
          <div class="map-level-node__label">${l?Fu[o].name:"???"}</div>
        </div>
        ...
        <div class="pixel-border">
          ...
          <div class="campaign-map">
            ...
            <div class="level-detail-box">
              ...
              <div class="level-detail-box__badge text-game-gray pixel-border">${e}/${Vr}</div>
            </div>
          </div>
        </div>
    ...
    `}renderTeamTab(){const e=Array.from({length:this.teamSize}).map((i,r)=>{const a=this.state.team[r],o=(a==null?void 0:a.id)==="commander",l=a?"filled":"",c=o?"commander":"";if(a){const u=a.avatarImg?`<img src="${a.avatarImg}" alt="${a.name}">`:'<span style="font-size:8px;color:var(--c-gray)">?</span>';return`
      ...
      `}).join(""),t=this.state.inventory.map(i=>{const r=this.state.team.some(l=>l.id===i.id),a=i.avatarImg?`<img src="${i.avatarImg}" alt="${i.name}">`:'<span style="font-size:8px;color:var(--c-gray)">?</span>',o=i.maxHealth?YM(i.maxHealth):"";return`
    ...
    `}renderShopTab(){const e=WM(this.playerState);return`
      <section class="lobby-screen" data-testid="shop-tab">
        <div class="pixel-border">
          <div class="lobby-window__title gold">▸ МАГАЗИН</div>
          <div class="shop-items">${e.items.map(n=>new zM({data:n,owned:e.owned(n.id),disabled:e.disabled(n.id)}).render()).join("")}</div>
        </div>
      </section>
    `}renderResults(){const e=this.combatResult==="win";return`
      <div class="lobby-results ${e?"win":"lose"}" data-testid="results">
        <div class="game-overlay__box pixel-border">
          ...
          <div class="text-[12px] text-game-gold mb-4">+${e?Nu:Uu} 💰</div>
          <button type="button" class="mode-btn" data-action="back-to-lobby">В ЛОББИ</button>
        </div>
      </div>
    `}attachListenersOnce(){this.listenersAttached||(this.listenersAttached=!0,this.container.addEventListener("click",e=>{var c;const t=qM(this.container,e.target),n=t==null?void 0:t.getAttribute("data-tab");if(n){this.state.activeTab=n,this.rerender();return}const i=XM(this.container,e.target),r=i==null?void 0:i.getAttribute("data-action");if(r&&i){this.handleAction(r,i);return}const a=e.target,o=(c=a==null?void 0:a.closest)==null?void 0:c.call(a,"[data-unit-id]"),l=o==null?void 0:o.getAttribute("data-unit-id");l&&this.toggleUnit(l)}),this.container.addEventListener("keydown",e=>{var a;const t=e.key;if(t!=="Enter"&&t!==" ")return;const n=e.target,i=(a=n==null?void 0:n.closest)==null?void 0:a.call(n,"[data-unit-id]"),r=i==null?void 0:i.getAttribute("data-unit-id");r&&(e.preventDefault(),this.toggleUnit(r))}))}handleAction(e,t){var n,i,r,a;if(e==="level-select"){const o=parseInt(t.getAttribute("data-level")??"1",10);o<=this.state.currentLevel&&(this.state.selectedLevel=Is(o),this.rerender());return}if(e==="set-mode"){const o=t.getAttribute("data-mode")==="pvp"?"pvp":"pve";this.state.gameMode=o,this.playerState={...this.playerState,gameMode:o},(n=this.onPlayerStateChange)==null||n.call(this,this.playerState),this.rerender();return}if(e==="play"){if(this.state.team.length===0){this.state.activeTab="team",this.rerender();return}(i=this.onRequestStart)==null||i.call(this,{isTutor:!1,team:this.state.team,mode:this.state.gameMode});return}if(e==="tutor"){(r=this.onRequestStart)==null||r.call(this,{isTutor:!0,team:this.state.team,mode:this.state.gameMode});return}if(e==="confirm"){if(this.state.team.length===0)return;(a=this.onRequestStart)==null||a.call(this,{isTutor:!1,team:this.state.team,mode:this.state.gameMode});return}if(e==="buy"){const o=t.getAttribute("data-item-id");if(!o)return;this.buy(o);return}if(e==="back-to-lobby"){this.finishBattle();return}}toggleUnit(e){if(e==="commander")return;if(this.state.team.find(i=>i.id===e)){this.state.team=this.state.team.filter(i=>i.id!==e),this.syncDeckToStorage(),this.rerender();return}if(this.state.team.length>=this.teamSize)return;const n=this.state.inventory.find(i=>i.id===e);n&&(this.state.team=[...this.state.team,n],this.syncDeckToStorage(),this.rerender())}buy(e){var r,a;if(this.playerState.ownedFighters.includes(e)||this.playerState.ownedSkins.includes(e))return;const t=(()=>{try{return Si(e)}catch{return null}})();if(t){if(this.playerState.currency<t.unlock.price)return;const o=this.playerState.currency-t.unlock.price,l=ks(t);this.playerState={...this.playerState,currency:o,ownedFighters:Array.from(new Set([...this.playerState.ownedFighters,t.id]))},this.state.currency=o,this.state.inventory=[...this.state.inventory,l],(r=this.onPlayerStateChange)==null||r.call(this,this.playerState),this.rerender();return}const n=(()=>{try{return kM(e)}catch{return null}})();if(!n||this.playerState.currency<n.price)return;const i=this.playerState.currency-n.price;this.playerState={...this.playerState,currency:i,ownedSkins:Array.from(new Set([...this.playerState.ownedSkins,n.id]))},this.state.currency=i,(a=this.onPlayerStateChange)==null||a.call(this,this.playerState),this.rerender()}finishBattle(){var t;if(!this.combatResult)return;const e=this.combatResult==="win";this.state.currency+=e?Nu:Uu,e&&this.state.selectedLevel===this.state.currentLevel&&(this.state.currentLevel=Math.min(Vr,this.state.currentLevel+1),this.state.selectedLevel=Math.min(Vr,this.state.selectedLevel+1)),this.combatResult=null,this.uiState="lobby",this.state.activeTab="home",this.playerState={...this.playerState,currency:this.state.currency},(t=this.onPlayerStateChange)==null||t.call(this,this.playerState),this.rerender()}showResults(e){e.selectedLevel!==void 0&&(this.state.selectedLevel=Is(e.selectedLevel)),this.combatResult=e.result,this.uiState="results",this.rerender()}setCurrency(e){this.state.currency=Math.max(0,Math.floor(e)),this.uiState==="lobby"&&this.rerender()}setLevel(e){const t=Is(e);this.state.currentLevel=t,this.state.selectedLevel=Math.min(this.state.selectedLevel,t),this.uiState==="lobby"&&this.rerender()}getCurrency(){return this.state.currency}getLevel(){return this.state.currentLevel}syncDeckToStorage(){var t;const e=Ou(this.state.team.map(n=>n.id));this.playerState={...this.playerState,deck:e},this.state.team=e.map(n=>ks(Si(n))),(t=this.onPlayerStateChange)==null||t.call(this,this.playerState)}}const bd="pixi_destroy_player_state_v1";function Ad(s){return Math.max(0,Math.floor(s))}function es(s){return Array.from(new Set(s.filter(Boolean)))}function Bu(){return{currency:100,ownedFighters:[],ownedSkins:[],deck:[],gameMode:"pve"}}function ku(){const s=localStorage.getItem(bd);if(!s)return Bu();const e=JSON.parse(s),t=Bu(),n=e.gameMode==="pvp"?"pvp":e.gameMode==="pve"?"pve":t.gameMode;return{currency:Ad(typeof e.currency=="number"?e.currency:t.currency),ownedFighters:es(Array.isArray(e.ownedFighters)?e.ownedFighters:t.ownedFighters),ownedSkins:es(Array.isArray(e.ownedSkins)?e.ownedSkins:t.ownedSkins),deck:es(Array.isArray(e.deck)?e.deck:t.deck),gameMode:n}}function KM(s){const e={currency:Ad(s.currency),ownedFighters:es(s.ownedFighters),ownedSkins:es(s.ownedSkins),deck:es(s.deck),gameMode:s.gameMode==="pvp"?"pvp":"pve"};localStorage.setItem(bd,JSON.stringify(e))}const Cr=[{message:"ДОБРО ПОЖАЛОВАТЬ",subtext:"Это тактическая игра на сетке. Синие юниты — твои.",waitFor:"next",lockInput:!0},{message:"КОМАНДИР",subtext:"Золотой — твой командир. Если его убьют — ты проиграл.",waitFor:"next",lockInput:!0,highlightTile:{x:1,y:4}},{message:"ПУСТАЯ КЛЕТКА",subtext:"Одна клетка всегда пустая. Ход — сдвинуть ряд к ней.",waitFor:"next",lockInput:!0,highlightTile:{x:0,y:0}},{message:"СДЕЛАЙ ХОД",subtext:"Нажми на подсвеченную клетку чтобы сдвинуть ряд.",waitFor:"specific-move",lockInput:!0,allowedTile:{x:1,y:0},highlightTile:{x:1,y:0}},{message:"АТАКА",subtext:"После сдвига юниты автоматически атакуют врагов в линии.",waitFor:"next",lockInput:!0},{message:"ХОД ВРАГА",subtext:"Теперь противник делает свой ход. Наблюдай.",waitFor:"auto",lockInput:!0,afterAiMove:!0},{message:"ТВОЙ ХОД",subtext:"Сдвигай ряды, чтобы твои юниты атаковали командира врага.",waitFor:"any-move",lockInput:!1},{message:"ЦЕЛЬ",subtext:"Убей командира врага — и победишь. Удачи!",waitFor:"next",lockInput:!1}],zu={boardSize:6,empty:{x:0,y:0},placements:[{x:1,y:4,type:"commander",owner:1},{x:1,y:2,type:"archer",owner:1},{x:2,y:3,type:"swordsman",owner:1},{x:4,y:1,type:"commander",owner:2},{x:4,y:3,type:"archer",owner:2},{x:3,y:4,type:"swordsman",owner:2}]};class jM{constructor(){Le(this,"stepIndex",0);Le(this,"done",!1)}get current(){return Cr[this.stepIndex]}get stepNumber(){return this.stepIndex}get total(){return Cr.length}get isLastStep(){return this.stepIndex>=Cr.length-1}get isDone(){return this.done}next(){return this.stepIndex<Cr.length-1?(this.stepIndex++,!0):(this.done=!0,!1)}onPlayerMove(e){const t=this.current;return t.waitFor==="any-move"?(this.next(),!0):t.waitFor==="specific-move"&&t.allowedTile&&e.x===t.allowedTile.x&&e.y===t.allowedTile.y?(this.next(),!0):!1}onAiMove(){return this.current.afterAiMove?(this.next(),!0):!1}reset(){this.stepIndex=0,this.done=!1}}const ZM="tutorial-overlay";class JM{constructor(e){Le(this,"el");Le(this,"onNext",null);this.el=document.createElement("div"),this.el.id=ZM,this.el.style.cssText=`
      position: absolute;
      bottom: 60px;
      left: 50%;
    ...
    `,!document.getElementById("tutorial-keyframes")){const c=document.createElement("style");c.id="tutorial-keyframes",c.textContent=`
      ...
      `,document.head.appendChild(c)}e.appendChild(i)}clearTileMarker(){var e;(e=document.getElementById("tutorial-tile-marker"))==null||e.remove()}destroy(){this.hide(),this.clearTileMarker(),this.el.remove()}}const gi="preGame",Ir="play",qi="gameOver",Pr="tutorial",ja="loading",kn="preGameChoice";function QM(s,e,t){const n=jt(e),i=t.getCurrent(),r=[`FSM: ${i??"—"}`,i===gi?"Клик — начать игру":null,n?`Ход: ${n.currentPlayer}`:null,n!=null&&n.gameOver?"Игра: конец":null,n!=null&&n.winner?`Победитель: ${n.winner}`:null].filter(Boolean);s.textContent=r.join(`
`)}function eE(s){const e=document.getElementById("army-p1-title"),t=document.getElementById("army-p2-title");e&&(e.textContent="АРМИЯ P1"),t&&(t.textContent=s==="pve"?"АРМИЯ AI":"АРМИЯ P2")}function tE(s,e){const t=document.getElementById("turn-indicator");if(!t)return;const n=jt(s);if(!n)return;if(e==="pve"){const r=n.currentPlayer===1;t.textContent=r?"ВАШ ХОД":"ХОД ИИ",t.style.borderColor=r?"#fff":"#b0305c",t.style.color=r?"#fff":"#b0305c";return}const i=n.currentPlayer===1;t.textContent=i?"ХОД ИГРОКА 1":"ХОД ИГРОКА 2",t.style.borderColor=i?"#5d86ba":"#b0305c",t.style.color=i?"#5d86ba":"#b0305c"}function nE(s,e,t){const n=document.getElementById("game-overlay"),i=document.getElementById("game-overlay__title"),r=document.getElementById("game-overlay__subtitle");if(!n||!i||!r)return;const a=jt(s),o=by(e.getCurrent(),a==null?void 0:a.winner,t);n.classList.toggle("visible",o.visible),n.classList.toggle("victory",o.variant==="victory"),n.classList.toggle("defeat",o.variant==="defeat"),n.classList.toggle("p1-win",o.variant==="p1"),n.classList.toggle("p2-win",o.variant==="p2"),i.textContent=o.title,r.textContent=o.subtitle}function iE(s,e,t){const n=new tx({antialias:!1});return Kx(n),n.setPixelRatio(1),n.setSize(e,t),n.domElement.style.imageRendering="pixelated",n.domElement.style.width="100%",n.domElement.style.height="100%",n.toneMapping=Zr,n.toneMappingExposure=1.6,s.insertBefore(n.domElement,s.firstChild),n}function Vu(s,e,t){const n=s.getBoundingClientRect();return{x:(e-n.left)/n.width*2-1,y:-((t-n.top)/n.height)*2+1}}const Za=4/3;function Gu(s,e,t){return e===null?!1:(s-e)*1e3>=t}function Hu(s,e,t,n){const i=e.clientWidth,r=e.clientHeight;if(i<=0||r<=0)return;const a=r>=i*(1/Za),o=a?i:r*Za,l=a?i/Za:r;s.style.width=`${o}px`,s.style.height=`${l}px`;const c=s.querySelector("#game-ui");c&&(c.style.transform=`scale(${o/t}, ${l/n})`)}function Ja(s,e,t,n){const i=new om;i.setFromCamera(new Be(n.x,n.y),t);const a=i.intersectObject(e,!0)[0];if(!a)return null;const o=TS(a.object,e),l=o==null?void 0:o.userData;if((l==null?void 0:l.entityId)===void 0)return null;const c=s.getComponent(l.entityId,dt);return c?{x:c.x,y:c.y}:null}async function sE(){const s=document.getElementById("app"),e=document.getElementById("game-viewport");if(!s||!e)return;const t=document.getElementById("meta-root");if(!t)return;const n=document.getElementById("loading-overlay"),i=document.getElementById("loading-percent"),r=document.getElementById("loading-bar"),a=document.getElementById("loading-detail"),o=(X,z)=>{i&&(i.textContent=`${X}%`),r&&(r.style.width=`${X}%`);const j=r==null?void 0:r.parentElement;j&&j.setAttribute("aria-valuenow",String(X)),a&&(a.textContent=z)},l=X=>n==null?void 0:n.classList.toggle("screen-overlay--hidden",!X),c=new au;c.add(ja,{}),c.add(kn,{}),c.allow(ja,kn),l(!0),c.go(ja);const u=await AM(X=>o(X.percent,X.detail));l(!1),c.go(kn);const{board:d,render:h}=u.appConfig;Hu(e,s,h.width,h.height),window.addEventListener("resize",()=>Hu(e,s,h.width,h.height));const f=iE(e,h.width,h.height),g=_x(),S=h.width/h.height,m=yx(S);g.add(new Gp(10528960,1.2));const p=new vh(16777215,1.8);p.position.set(4,10,4),g.add(p);const v=new JS;let M="pve",E=0;const A=u.unitModels;let w=!0;const C=X=>{w=X,t.classList.toggle("meta-hidden",!X)};C(!0);const x=e.querySelector("#game-ui"),T=X=>{x&&(x.style.display=X?"":"none")};T(!1);const H=ku(),R=jh().map(X=>X.id),F=(X,z)=>X.map(j=>{const oe=Si(j);return{owner:z,type:oe.unitType,fighterId:oe.id}}),k=["commander",...R.filter(X=>X!=="commander")],q=X=>X.length?X:k,O=new jM,G=new JM(e),U=new $M({teamSize:3,playerState:H,onPlayerStateChange:X=>KM(X),onRequestStart:({isTutor:X,mode:z})=>{w&&C(!1),ye(z,X),T(!0),xe.start()}});U.mount(t);const re={boardSize:d.boardSize,empty:d.empty,placements:[...F(q(H.deck),1),...F(R,2)]},Q=ou(re);Ha(v,Q),v.addSystem(ey),v.addSystem(cy),v.addSystem(uy);const pe=Q.boardSize,ee=pS(pe),me=(pe-1)/2;ee.position.set(-me,0,-me),g.add(ee);const De=MS();De.position.set(ee.position.x,ee.position.y,ee.position.z),g.add(De);const Qe=US(u.arrowTexture);ee.add(Qe);let Ke=null;Bn(v,ee,A),Jn(v);const{composer:K,backgroundUniforms:ie}=Yx(f,g,m,h),ce=h.background??{colorTransitionDuration:.5,shakeDuration:.15},Ue={1:new L(93/255,134/255,186/255),2:new L(176/255,48/255,92/255)};let _e=0,Ie=0,mt=1,We=-1;const Ze=500;let qe=null;function Fe(X,z,j,oe,se){const ne=sy(X);if(ne){Bn(X,z,j);const Ce=Ht(X,ne.attackerPos.x,ne.attackerPos.y);if(Ce!==void 0){const P=X.getComponent(Ce,Ji);X.addComponent(Ce,Ji,{clipIds:P.clipIds,playing:{clipId:"attack_squash",startTime:se}})}ne.type==="swordsman"?(FS(oe,ne.attackerPos,ne.owner,se),Ke=se+zS):(OS(oe,ne.attackerPos,ne.targets,ne.owner,se),Ke=se+VS)}else pt(X,z,j)}function pt(X,z,j){const oe=Tn(X);if(oe!==void 0){const se=X.getComponent(oe,Tt);se&&X.addComponent(oe,Tt,{...se,skipAttackResolution:!1})}cd(X),Bn(X,z,j),Jn(X),jo(X)}function I(){const X=Tn(v);if(X===void 0)return;const z=v.getComponent(X,Tt);z&&v.addComponent(X,Tt,{...z,damageDealtThisTick:!1})}let et=null,Ge;const at=X=>{n&&!n.classList.contains("screen-overlay--hidden")||(et=Vu(e,X.clientX,X.clientY))};s.addEventListener("click",at),s.addEventListener("mousemove",X=>{var Y,Se;const z=(Se=(Y=X.target).closest)==null?void 0:Se.call(Y,".unit-card");if(z){const Re=z.getAttribute("data-entity-id");if(Re){const it=parseInt(Re,10),je=v.getComponent(it,ht);if(je&&je.owner!==0){const on=Ko(v,it);Rs(De,on,je.owner),Xi(v,ee,[]);return}}}const j=Vu(e,X.clientX,X.clientY),oe=Ja(v,ee,m,j);if(!oe){Rs(De,[]),Xi(v,ee,[]);return}const se=Ht(v,oe.x,oe.y);if(se===void 0){Rs(De,[]),Xi(v,ee,[]);return}const ne=v.getComponent(se,ht);if(ne&&ne.owner!==0){const Re=Ko(v,se);Rs(De,Re,ne.owner)}else Rs(De,[]);if(!Us(v).includes(se)){Xi(v,ee,[]);return}const le=$s(v),ae=v.getComponent(se,dt);if(!le||!ae){Xi(v,ee,[]);return}const ge=sa(le,ae),te=ge?ge.map(Re=>({x:Re.x,y:Re.y})):[];Xi(v,ee,te)});const xe=new nx,b=new au;document.addEventListener("visibilitychange",()=>{document.hidden&&xe.stop()}),b.add(gi,{update(){yS(ee)&&b.go(Ir),K.render()}}),b.add(Ir,{enter(){E+=1,SS(ee),PM(M,E)},update(X){const z=jt(v);if(z!=null&&z.gameOver){z.winner!==void 0&&Lu(M,$(M,z.winner),E),b.go(qi);return}if(Ke!==null){K.render();return}if((M==="pvp"?(z==null?void 0:z.currentPlayer)===1||(z==null?void 0:z.currentPlayer)===2:(z==null?void 0:z.currentPlayer)===1)&&et){const oe=Ja(v,ee,m,et),se=oe?Ht(v,oe.x,oe.y):void 0,ne=Us(v),Ce=se!==void 0&&ne.includes(se);if(et=null,oe&&Ce&&se!==void 0){Ge=M==="pve"?se:void 0;const P=Tn(v),le=P!==void 0?jt(v):void 0;P!==void 0&&le&&(v.addComponent(P,Tt,{...le,pendingShiftTileId:se,skipAttackResolution:!0}),v.tick(0)),Bn(v,ee,A),Jn(v),Du(M),Fe(v,ee,A,Qe,_e)}}M==="pve"&&(z==null?void 0:z.currentPlayer)===2&&(qe===null&&(qe=_e),Gu(_e,qe,Ze)&&(Su(v,Ge),Ge=void 0,qe=null,Bn(v,ee,A),Jn(v),Fe(v,ee,A,Qe,_e))),K.render()}}),b.add(qi,{enter(){const X=jt(v);if((X==null?void 0:X.winner)!==void 0){const j=X.winner===1;U.showResults({result:j?"win":"lose"})}else U.showResults({result:"lose"});const z=document.getElementById("game-overlay");z==null||z.classList.remove("visible"),xe.stop(),T(!1),et=null,Ge=void 0,Ke=null,C(!0),b.go(kn)},update(){K.render()}}),b.add(Pr,{enter(){O.reset(),_()},update(X){const z=O.current,j=jt(v);if(j!=null&&j.gameOver){G.hide(),G.clearTileMarker(),j.winner!==void 0&&Lu(M,$(M,j.winner),E),b.go(qi);return}if(Ke!==null){K.render();return}if(z.afterAiMove&&(j==null?void 0:j.currentPlayer)===2){qe===null&&(qe=_e),Gu(_e,qe,Ze)&&(Su(v,Ge),Ge=void 0,qe=null,Bn(v,ee,A),Jn(v),Fe(v,ee,A,Qe,_e),O.onAiMove(),_()),K.render();return}if((j==null?void 0:j.currentPlayer)===1&&et){const se=Ja(v,ee,m,et);if(et=null,se&&!z.lockInput){const ne=Ht(v,se.x,se.y),Ce=Us(v);ne!==void 0&&Ce.includes(ne)&&(D(ne),O.onPlayerMove(se),_())}else if(se&&z.lockInput&&z.allowedTile){const ne=Ht(v,se.x,se.y),Ce=Us(v);ne!==void 0&&Ce.includes(ne)&&O.onPlayerMove(se)&&(D(ne),_())}}K.render()},exit(){G.hide(),G.clearTileMarker()}});function _(){if(O.isDone){G.hide(),G.clearTileMarker();return}const X=O.current;G.show(X,O.stepNumber,O.total,()=>{O.next(),_()}),X.highlightTile?G.showTileMarker(e,zu.boardSize,X.highlightTile):G.clearTileMarker()}function D(X,z){Ge=M==="pve"?X:void 0;const j=Tn(v),oe=j!==void 0?jt(v):void 0;j!==void 0&&oe&&(v.addComponent(j,Tt,{...oe,pendingShiftTileId:X,skipAttackResolution:!0}),v.tick(0)),Bn(v,ee,A),Jn(v),Du(M),Fe(v,ee,A,Qe,_e)}b.allow(gi,Ir),b.allow(gi,Pr),b.allow(Pr,qi),b.allow(Ir,qi),b.allow(qi,kn),b.add(kn,{}),b.allow(kn,gi);function Z(){v.clear();const X=ku().deck,z={boardSize:d.boardSize,empty:d.empty,placements:[...F(q(X),1),...F(R,2)]},j=ou(z);Ha(v,j),Bn(v,ee,A),Jn(v)}function J(X){v.clear(),Ha(v,X),Bn(v,ee,A),Jn(v)}function $(X,z){return X==="pve"?z===1?"victory":"defeat":z===1?"p1_win":"p2_win"}function ye(X,z=!1){M=X,IM(X),qe=null,eE(M),z?J(zu):Z(),mt=1,Ie=_e,ie.uColorPrev.value.copy(Ue[1]),ie.uColorCurrent.value.copy(Ue[1]),ie.uColorMix.value=1,vS(ee),b.go(kn),z?b.go(Pr):b.go(gi),C(!1)}const ue=document.getElementById("game-overlay__play-again");ue==null||ue.addEventListener("click",X=>{X.stopPropagation(),DM(),xe.stop(),T(!1),et=null,Ge=void 0,C(!0),b.go(kn)});const be=document.getElementById("state-ui");xe.setTick(X=>{_e+=X;const z=jt(v);if(z){z.currentPlayer!==mt&&(Ie=_e,ie.uColorPrev.value.copy(Ue[mt]),ie.uColorCurrent.value.copy(Ue[z.currentPlayer]),mt=z.currentPlayer);const oe=Math.min(1,(_e-Ie)/ce.colorTransitionDuration);ie.uColorMix.value=oe,z.damageDealtThisTick&&(We=_e,I())}const j=_e-We;ie.uShake.value=We>=0&&j<ce.shakeDuration?Math.max(0,1-j/ce.shakeDuration):0,j>=ce.shakeDuration&&(We=-1),ie.uTime.value=_e,Mx(m,S),$x(K,h.width,h.height),b.getCurrent()===gi?xS(ee,X):(_S(ee,X),ZS(v,ee,_e)),Ke!==null&&kS(Qe,_e)&&(Ke=null,pt(v,ee,A)),QM(be,v,b),tE(v,M),nE(v,b,M),b.update(X)})}sE().catch(console.error);
